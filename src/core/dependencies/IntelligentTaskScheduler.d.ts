...
import { DependencyAnalyzer, TaskNode, TaskDependency } from './DependencyAnalyzer.js';
/**
...
export declare class IntelligentTaskScheduler extends EventEmitter {
    ...
    constructor(dependencyAnalyzer: DependencyAnalyzer, resourceConstraints?: Partial<ResourceConstraints>, schedulingStrategy?: Partial<SchedulingStrategy>);
    /**
