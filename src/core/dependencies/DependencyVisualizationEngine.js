...
import {
  ...
  _ExecutionReadiness,
  _DependencyConflict,
} from './_DependencyAnalyzer.js';
import {
  _IntelligentTaskScheduler,
  _ExecutionContext,
  _SystemMetrics,
  _SchedulingEvent,
} from './_IntelligentTaskScheduler.js';
/**
...
export class DependencyVisualizationEngine extends EventEmitter {
  ...
  updatePerformanceData() {
    ...
    // Update heatmap data
    for (const [nodeId, _node] of this.visualizationData.nodes) {
   ...
   */
  calculateNodePosition(_nodeData) {
   ...
   */
  calculateNodeColor(nodeData, _analysis) {
