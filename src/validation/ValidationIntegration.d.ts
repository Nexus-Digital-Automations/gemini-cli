...
import { ValidationResult } from './AutomaticValidationSystem.js';
/**
 ...
 */
export declare function createValidationIntegration(
  projectRoot: string,
 ...
 */
export declare function validateTaskCompletion(
  projectRoot: string,
  taskDescription: string,
  taskCategory?:
    | 'feature'
 ...
 */
export declare function isProjectReadyForCompletion(
  projectRoot: string,
): Promise<boolean>;
/**
 * Utility function to get stop authorization status.
 */
export declare function getStopAuthorizationStatus(
  projectRoot: string,
  taskDescription?: string,
