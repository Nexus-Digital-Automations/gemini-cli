...
export async function exampleTodoWriteIntegration() {
    ...
    const todoTasks = [
        { description: 'Implement user authentication API', category: 'feature' },
        { description: 'Fix memory leak in data processor', category: 'bug-fix' },
        { description: 'Refactor database connection pooling', category: 'refactoring' },
        { description: 'Add unit tests for payment service', category: 'testing' },
        { description: 'Update API documentation for v2.0', category: 'documentation' }
    ];
