...
export declare class PerformanceOptimizationEngine extends EventEmitter {
     ...
     */
    analyzeValidationPerformance(report: ValidationReport): Promise<PerformanceAnalysis>;
    /**
     ...
     */
    trackOptimization(recommendationId: string, update: Partial<OptimizationTracking>): void;
    /**
