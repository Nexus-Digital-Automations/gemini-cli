...
export class SecurityValidator {
   ...
   */
  private parseNpmAuditResults(auditResult: any): SecurityVulnerability[] {
   ...
   */
  private async runYarnAudit(): Promise<SecurityScanResult> {
    const startTime = Date.now();
   ...
   */
  private parseYarnAuditResults(jsonOutput: string): SecurityVulnerability[] {
    const vulnerabilities: SecurityVulnerability[] = [];
   ...
   */
  private async runESLintSecurity(): Promise<SecurityScanResult> {
    const startTime = Date.now();
   ...
   */
  private async runSemgrep(): Promise<SecurityScanResult> {
    const startTime = Date.now();
   ...
   */
  private parseSemgrepResults(semgrepResult: any): SecurityVulnerability[] {
    const vulnerabilities: SecurityVulnerability[] = [];
   ...
   */
  private async runBandit(): Promise<SecurityScanResult> {
    const startTime = Date.now();
   ...
   */
  private parseBanditResults(banditResult: any): SecurityVulnerability[] {
    const vulnerabilities: SecurityVulnerability[] = [];
   ...
   */
  private async runSecretsDetection(): Promise<SecurityScanResult> {
    const startTime = Date.now();
   ...
   */
  private async runGitSecrets(): Promise<SecurityScanResult> {
    const startTime = Date.now();
   ...
   */
  private async runTruffleHog(): Promise<SecurityScanResult> {
    const startTime = Date.now();
   ...
   */
  private parseTruffleHogResults(jsonOutput: string): SecurityVulnerability[] {
    const vulnerabilities: SecurityVulnerability[] = [];
   ...
   */
  private async runLicenseCheck(): Promise<SecurityScanResult> {
    const startTime = Date.now();
   ...
   */
  private checkLicenseCompliance(dependencies: any): SecurityVulnerability[] {
    const violations: SecurityVulnerability[] = [];
   ...
   */
  private async runDockerSecurity(): Promise<SecurityScanResult> {
    const startTime = Date.now();
   ...
   */
  private generateSecurityMessage(summary: SecuritySummary): string {
    if (summary.totalVulnerabilities === 0) {
   ...
   */
  private generateSecurityDetails(summary: SecuritySummary): string {
   ...
   */
  private generateSecuritySuggestions(summary: SecuritySummary): string[] {
   ...
   */
  private createSecurityEvidence(summary: SecuritySummary) {
    const evidence = [];
