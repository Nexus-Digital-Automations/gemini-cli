...
describe('Autonomous Task Management System E2E', () => {
  ...
  describe('complete system lifecycle', () => {
    it('should initialize, run tasks, and shutdown gracefully', async () => {
      ...
      // 3. Queue tasks
      const task1Id = await systemInitializer.queueTask(
      ...
      const task2Id = await systemInitializer.queueTask(
        ...
        'Perform comprehensive security review of auth implementation',
        {
  ...
  describe('integration with external components', () => {
    it('should integrate with task execution engine', async () => {
      ...
      const taskId = await systemInitializer.queueTask(
        ...
        'Implement a complex feature that requires multiple subtasks, dependency management, and comprehensive testing',
        {
          type: TaskType.IMPLEMENTATION,
    ...
    it('should handle quality gate integration', async () => {
      ...
      const taskId = await systemInitializer.queueTask(
        'Quality gate test task',
        'Task to test quality gate integration',
        {
          type: TaskType.IMPLEMENTATION,
          context: {
