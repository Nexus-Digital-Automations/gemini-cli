...
export declare class MockAgentFactory {
     ...
     */
    static createMockAgent(config: MockAgentConfig, runtimeContext: Config, promptConfig: PromptConfig, modelConfig: ModelConfig, runConfig: RunConfig, options?: SubAgentOptions): Promise<SubAgentScope>;
    /**
     * Creates multiple mock agents for concurrent testing
     */
    static createMockAgentPool(configs: MockAgentConfig[], runtimeContext: Config): Promise<SubAgentScope[]>;
    /**
     ...
     */
    static validateAgentExecution(agentName: string, expectedState: MockAgentState, expectedOutputKeys?: string[]): boolean;
}
