 ...
 */
export declare enum BoostConditionType {
    WAIT_TIME = "wait_time",
 ...
 * Dependency resolution strategy
 */
export declare enum DependencyResolutionStrategy {
    STRICT = "strict",
    LENIENT = "lenient",
 ...
 * Circular dependency handling
 */
export declare enum CircularDependencyHandling {
    ERROR = "error",
    WARNING = "warning",
    IGNORE = "ignore",
 ...
 */
export declare enum PreemptionStrategy {
