...
export const fsHelper = {
  ...
  createMockFs(structure: TestFileSystem): void {
    const directoryJson: DirectoryJSON = this.convertToDirectoryJson(structure);
   ...
   */
  convertToDirectoryJson(structure: TestFileSystem, basePath = ''): DirectoryJSON {
   ...
   */
  createBasicProjectStructure(projectRoot = '/test-project'): void {
    this.createMockFs({
   ...
   */
  createLockFile(filePath: string, pid: number = 12345): void {
