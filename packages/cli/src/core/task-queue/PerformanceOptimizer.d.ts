...
export declare class PerformanceOptimizer extends EventEmitter {
     ...
     */
    getPerformanceHistory(interval: 'minute' | 'hour' | 'day' | 'week', limit?: number): PerformanceHistory | undefined;
    /**
 ...
 */
export declare function createPerformanceOptimizer(taskQueue: TaskQueue): PerformanceOptimizer;
export {};
