...
describe('EnhancedMonitoringDashboard', () => {
  let dashboard;
  let mockRealTimeMonitoring;
  beforeEach(async () => {
    vi.clearAllMocks();
    mockRealTimeMonitoring = realTimeMonitoringSystem;
  ...
  describe('Layout Management', () => {
    ...
    it('should list layouts sorted by last modified', () => {
      const _layout1Id = dashboard.createLayout('Layout 1', 'First layout');
      const _layout2Id = dashboard.createLayout('Layout 2', 'Second layout');
      const layouts = dashboard.getLayouts();
  ...
  describe('Error Handling', () => {
    it('should handle widget data source errors gracefully', () => {
      ...
      for (const _widget of dashboardData.widgets) {
...
//# sourceMappingURL=EnhancedMonitoringDashboard.test.js.map
