...
describe('TaskStatusMonitor', () => {
    ...
    describe('Task Filtering and Querying', () => {
        ...
        it('should sort tasks by last update date', () => {
            ...
            for (let i = 1; i < allTasks.length; i++) {
                expect(allTasks[i - 1].lastUpdate.getTime()).toBeGreaterThanOrEqual(allTasks[i].lastUpdate.getTime());
            }
        });
    });
    ...
    describe('Error Handling', () => {
        ...
        it('should handle task updates for invalid statuses gracefully', async () => {
            ...
            const result = await monitor.updateTaskStatus(taskId, 'invalid_status');
...
//# sourceMappingURL=TaskStatusMonitor.test.js.map