...
describe('Monitoring System Performance Tests', () => {
    ...
    describe('Response Time Performance', () => {
        ...
        Target: ${PERFORMANCE_TARGETS.snapshotCollectionTime}ms`);
            ...
            expect(times.filter((t) => t < PERFORMANCE_TARGETS.snapshotCollectionTime)
                .length / iterations).toBeGreaterThan(0.95); // 95% should meet target
        });
    ...
    describe('Throughput Performance', () => {
        ...
        it('should handle concurrent monitoring operations', async () => {
            ...
            const avgOperationTime = allResults.reduce((sum, result) => sum + result.duration, 0) /
                totalOperations;
        ...
        it('should maintain performance under sustained load', async () => {
            ...
            const avgOperationTime = operationTimes.reduce((sum, time) => sum + time, 0) /
...
//# sourceMappingURL=MonitoringSystemPerformance.test.js.map