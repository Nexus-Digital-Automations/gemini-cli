...
export class TaskStatusMonitor extends EventEmitter {
     ...
     */
    getAllAgents() {
        return Array.from(this.agents.values()).sort((a, b) => b.lastHeartbeat.getTime() - a.lastHeartbeat.getTime());
    }
    /**
     * Get comprehensive performance metrics
     */
    getPerformanceMetrics() {
        const activeAgents = Array.from(this.agents.values()).filter((agent) => agent.status !== 'offline').length;
