...
export declare class NotificationSystem extends EventEmitter {
     ...
     */
    sendImmediateNotification(userId: string, event: StatusEvent, options?: {
     ...
     */
    sendBroadcastNotification(event: StatusEvent, options?: {
     ...
     */
    acknowledgeNotification(notificationId: string, userId: string, actionTaken?: string): void;
    /**
    ...
    }, limit?: number): DeliveredNotification[];
    /**
