...
export declare class MetricsCollector extends EventEmitter {
     ...
     */
    startTaskMetricsCollection(taskId: string, taskMetadata: TaskMetadata): Promise<void>;
    /**
     * Update task metrics during execution
     */
    updateTaskMetrics(taskId: string, updates: {
        status?: TaskStatus;
     ...
     */
    completeTaskMetricsCollection(taskId: string, finalStatus: TaskStatus): Promise<TaskPerformanceMetrics | null>;
    /**
