...
export declare class TaskMonitor extends EventEmitter {
     ...
     */
    startMonitoring(taskId: string, config?: Partial<TaskMonitoringConfig>): Promise<void>;
    /**
     ...
     */
    completeTask(taskId: string, result: 'success' | 'failure', details?: Record<string, unknown>): Promise<void>;
