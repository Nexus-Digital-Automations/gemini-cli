...
export class StatusHistoryAnalytics {
    ...
    async calculateAgentMetrics(entries, _timeframe) {
    ...
    parseBucketKey(key, granularity) {
        ...
        switch (granularity) {
            case 'hour':
                return new Date(parseInt(parts[0], 10), parseInt(parts[1], 10), parseInt(parts[2], 10), parseInt(parts[3], 10));
            case 'day':
                return new Date(parseInt(parts[0], 10), parseInt(parts[1], 10), parseInt(parts[2], 10));
            case 'week':
            case 'month':
