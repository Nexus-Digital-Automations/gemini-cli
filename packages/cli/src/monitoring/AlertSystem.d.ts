...
export declare class AlertSystem extends EventEmitter {
     ...
     */
    processTaskStatusUpdate(task: TaskMetadata, update: TaskStatusUpdate): Promise<void>;
    /**
     ...
     */
    registerNotificationChannel(channel: NotificationChannel, delivery: NotificationDelivery): void;
