...
export declare class TaskStatusMonitor extends EventEmitter {
     ...
     */
    registerTask(task: Omit<TaskMetadata, 'id' | 'lastUpdate' | 'status' | 'progress' | 'errorCount' | 'retryCount'>): Promise<string>;
    /**
     * Update task status with comprehensive tracking
     */
    updateTaskStatus(taskId: string, newStatus: TaskStatus, options?: {
        agentId?: string;
        progress?: number;
        message?: string;
        error?: string;
