  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsx(Text, {
        bold: true,
        color: 'blue',
        children: 'Available AI Personas:',
      }),
      _jsx(Newline, {}),
      Array.from(personas.entries()).map(([id, persona]) =>
        _jsxs(
          Box,
          {
            flexDirection: 'column',
            ...
            children: [
              _jsxs(Box, {
                children: [
                  _jsxs(Text, {
                    bold: true,
                    color: id === activePersonaId ? 'green' : 'white',
                    children: [
                      id === activePersonaId ? '★ ' : '  ',
                      persona.name,
                    ],
      ...
      _jsx(Box, {
        ...
        children: _jsx(Text, {
          color: 'yellow',
          children: "Use 'persona switch <name>' to activate a persona",
        }),
      }),
    ],
  });
...
function PersonaDetailsComponent({ personaId }) {
  ...
  if (!persona) {
    return _jsxs(Text, {
      color: 'red',
      children: ["Persona '", personaId, "' not found"],
    });
  }
  return _jsxs(Box, {
    flexDirection: 'column',
    children: [
      _jsxs(Box, {
        marginBottom: 1,
        children: [
          _jsx(Text, { bold: true, color: 'blue', children: persona.name }),
          persona.isSystem &&
            _jsxs(Text, {
              color: 'gray',
              dimColor: true,
      ...
      _jsx(Box, {
        marginBottom: 1,
        children: _jsx(Text, { color: 'gray', children: persona.description }),
      }),
        ...
        children: [
          _jsxs(Text, {
            children: [
              ...
              _jsx(Text, {
                color: 'cyan',
                children: persona.personality.formality || 'default',
              }),
            ],
          }),
          _jsxs(Text, {
            children: [
              ...
              _jsx(Text, {
                color: 'cyan',
                children: persona.personality.verbosity || 'default',
              }),
            ],
          }),
          _jsxs(Text, {
            children: [
              ...
              _jsx(Text, {
                color: 'cyan',
                children: persona.personality.creativity || 'default',
              }),
            ],
          }),
          _jsxs(Text, {
            children: [
              ...
              _jsx(Text, {
                color: 'cyan',
                children: persona.personality.teachingStyle || 'default',
              }),
            ],
          }),
        ],
        ...
        children: [
          _jsxs(Text, {
            children: [
              ...
              _jsx(Text, {
                color: 'cyan',
                children: persona.behavior.proactiveness || 'default',
              }),
            ],
          }),
          _jsxs(Text, {
            children: [
              ...
              _jsx(Text, {
                color: 'cyan',
                children: persona.behavior.errorHandling || 'default',
              }),
            ],
          }),
          _jsxs(Text, {
            children: [
              ...
              _jsx(Text, {
                color: 'cyan',
                children: persona.behavior.codeStyle || 'default',
              }),
            ],
          }),
        ],
        ...
        _jsxs(Box, {
          ...
          children: [
            ...
            _jsx(Box, {
              marginLeft: 2,
              children: _jsx(Text, {
                children: persona.customization.customPromptAdditions,
              }),
            }),
          ],
        }),
        ...
        _jsxs(Box, {
          ...
          children: [
            _jsx(Text, {
              bold: true,
              color: 'yellow',
              children: 'Learning Focus Areas:',
            }),
            _jsx(Box, {
              flexDirection: 'column',
              marginLeft: 2,
              children: persona.customization.learningPreferences.map(
                (area, index) =>
                  _jsxs(Text, { children: ['\u2022 ', area] }, index),
              ),
            }),
          ],
        }),
        ...
        _jsxs(Box, {
          ...
          children: [
            _jsx(Text, {
              bold: true,
              color: 'yellow',
              children: 'Preferred Terminology:',
            }),
            _jsx(Box, {
              flexDirection: 'column',
              marginLeft: 2,
      ...
      .command(
        ...
        () => {
          render(
            _jsx(ErrorMessage, {
              message:
                'Interactive persona creation not yet implemented. Use the UI settings dialog instead.',
            }),
          );
        },
      )
