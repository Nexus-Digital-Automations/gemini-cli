 ...
 */
export async function getFeatureStats(): Promise<TaskManagerResponse> {
 ...
 */
export async function getInitializationStats(): Promise<TaskManagerResponse> {
 ...
 */
export async function getApiGuide(): Promise<TaskManagerResponse> {
 ...
 */
export async function listApiMethods(): Promise<TaskManagerResponse> {
