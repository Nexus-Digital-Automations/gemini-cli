...
import { GEMINI_DIR, Storage, Config, ExtensionInstallEvent, ExtensionUninstallEvent, ExtensionEnableEvent, logExtensionEnable, logExtensionInstallEvent, logExtensionUninstall, } from '@google/gemini-cli-core';
...
async function requestConsent(extensionConfig) {
    ...
    output.push('Ensure you have investigated the extension source and trust the author.');
