    ...
    return _jsxs(Box, {
      ...
      children: [
        _jsx(Text, {
          ...
          bold: true,
          marginBottom: 1,
          children: 'Budget Alerts & Notifications',
        }),
        _jsxs(Box, {
          ...
          children: [
            _jsxs(Box, {
              ...
              children: [
                _jsxs(Box, {
                  flexDirection: 'column',
                  children: [
                    _jsx(Text, { color: theme.text.muted, children: 'Active' }),
                    _jsx(Text, {
                      color:
                        activeCount > 0
                ...
                _jsxs(Box, {
                  flexDirection: 'column',
                  children: [
                    _jsx(Text, { color: theme.text.muted, children: 'Errors' }),
                    _jsx(Text, {
                      color:
                        errorCount > 0
                          ? theme.status.error
            ...
            _jsxs(Box, {
              ...
              alignItems: 'flex-end',
              children: [
                _jsx(Text, { color: theme.text.muted, children: 'Last Alert' }),
                _jsx(Text, {
    ...
    if (sortedAlerts.length === 0) {
      return _jsx(Box, {
        ...
        children: _jsx(Text, {
          ...
          children: '\u2705 No active alerts - Budget usage is within limits',
        }),
      });
    }
    return _jsxs(Box, {
      ...
      children: [
        _jsxs(Text, {
          color: theme.text.muted,
          marginBottom: 1,
          children: ['Active Alerts (', sortedAlerts.length, '):'],
        }),
                  ...
                  children: [
                    _jsxs(Box, {
                      ...
                      children: [
                        ...
                        _jsx(Text, { children: getTypeIcon(alert.type) }),
                        _jsx(Text, {
                    ...
                    _jsx(Text, {
                      color: theme.text.muted,
                      children: formatTime(alert.triggeredAt),
                    }),
                  ],
                }),
                _jsx(Text, {
                  ...
                  children: [
                    _jsxs(Box, {
                      ...
                      children: [
                        _jsxs(Text, {
                          color: theme.text.muted,
                          children: ['Threshold: ', alert.threshold],
                        }),
                        _jsxs(Text, {
                          color: theme.text.muted,
                          children: ['Current: ', alert.currentValue],
                        }),
                        _jsxs(Text, {
                          color: getSeverityColor(alert.severity),
    ...
    return _jsxs(Box, {
      ...
      children: [
        ...
        _jsx(Box, {
          gap: 4,
          marginBottom: 1,
          children: currentThresholds.map((threshold, index) =>
            _jsxs(
              Box,
              {
                alignItems: 'center',
        ...
        _jsxs(Box, {
          ...
          children: [
            _jsxs(Box, {
              flexDirection: 'column',
              children: [
                _jsx(Text, { color: theme.text.muted, children: 'Today' }),
                _jsx(Text, {
                  color: theme.text.primary,
                  children: todaysAlerts.length,
                }),
              ],
            }),
            _jsxs(Box, {
              flexDirection: 'column',
              children: [
                _jsx(Text, { color: theme.text.muted, children: 'Last Hour' }),
                _jsx(Text, {
                  color: theme.text.primary,
                  children: recentAlerts.length,
                }),
              ],
            }),
            _jsxs(Box, {
      ...
      children: [
        _jsxs(Box, {
          ...
          children: [
            _jsx(Text, {
              color: theme.text.muted,
              children: '\u2191\u2193/jk: Navigate',
            }),
            _jsx(Text, {
              color: theme.text.muted,
              children: 'Enter/Space: Dismiss',
            }),
            _jsx(Text, {
              color: theme.text.muted,
              children: 'd: Toggle dismissed',
            }),
          ],
        }),
        _jsx(Text, {
