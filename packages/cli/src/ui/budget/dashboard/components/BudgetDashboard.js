...
export const BudgetDashboard = ({
    ...
    return _jsxs(Box, {
      ...
      children: [
        _jsx(Text, {
          ...
          children: 'Budget tracking is disabled',
        }),
        _jsx(Text, {
          color: theme.text.secondary,
          children: 'Enable budget settings to view the dashboard',
        }),
      ],
    });
  }
  ...
  if (dashboardState.isLoading && !budgetStats) {
    return _jsxs(Box, {
      ...
      children: [
        _jsx(Text, {
          color: theme.text.secondary,
          children: 'Loading budget dashboard...',
        }),
        _jsx(Text, {
          color: theme.text.muted,
          children: 'Fetching real-time budget data',
        }),
      ],
    });
  }
  ...
  if (dashboardState.error) {
    return _jsxs(Box, {
      ...
      paddingY: 2,
      children: [
        _jsx(Text, { color: theme.status.error, children: 'Dashboard Error' }),
        _jsx(Text, {
          color: theme.text.secondary,
          children: dashboardState.error,
        }),
        _jsx(Text, { color: theme.text.muted, children: "Press 'r' to retry" }),
      ],
    });
  }
  /**
        ...
        _jsxs(Box, {
          ...
          children: [
            _jsx(Text, {
              ...
              bold: true,
              children: 'Budget Usage Dashboard',
            }),
            _jsxs(Text, {
              color: theme.text.secondary,
              children: [
                'Last updated: ',
                dashboardState.lastRefresh.toLocaleTimeString(),
              ],
            }),
          ],
        }),
              ...
              children: [
                _jsxs(Box, {
                  ...
                  children: [
                    ...
                    _jsxs(Text, {
                      color: usageColor,
                      children: [
                        budgetStats.requestCount,
                        '/',
                        budgetStats.dailyLimit,
                      ],
                    }),
                  ],
                }),
                _jsxs(Box, {
                  ...
                  children: [
                    ...
                    _jsx(Text, {
                      color: usageColor,
                      children: formatPercentage(budgetStats.usagePercentage),
                    }),
                  ],
                }),
                _jsxs(Box, {
                  ...
                  children: [
                    ...
                    _jsx(Text, {
                      color: theme.text.primary,
                      children: budgetStats.remainingRequests,
                    }),
                  ],
                }),
                _jsxs(Box, {
                  ...
                  children: [
                    ...
                    _jsx(Text, {
                      color: theme.text.muted,
                      children: budgetStats.timeUntilReset,
                    }),
                  ],
                }),
              ],
      ...
      children: [
        _jsxs(Box, {
          ...
          children: [
            ...
            _jsx(Box, {
              flexBasis: '50%',
              children: _jsx(CostBreakdownChart, {
                data: costBreakdown,
                config: {
  ...
  const renderTrendsView = () =>
    _jsx(Box, {
      flexDirection: 'column',
      gap: 1,
      children: _jsx(UsageTrendsGraph, {
        data: historicalData,
        config: {
      ...
      children: [
        _jsxs(Box, {
          ...
          children: [
            _jsx(Text, {
              color: theme.text.muted,
              children: '\u2190\u2192/hl: Navigate',
            }),
            _jsx(Text, {
              color: theme.text.muted,
              children: 'Enter/Space: Select',
            }),
            _jsx(Text, { color: theme.text.muted, children: 'r: Refresh' }),
            _jsx(Text, {
              color: theme.text.muted,
              children: 't: Toggle auto-refresh',
            }),
            _jsx(Text, { color: theme.text.muted, children: 'e: Export' }),
          ],
        }),
        _jsxs(Text, {
          color: theme.text.muted,
  ...
  return _jsxs(Box, {
    ...
    children: [
      renderNavigation(),
      renderHeader(),
      _jsx(Box, { flexGrow: 1, marginBottom: 1, children: renderContent() }),
