...
vi.mock('../charts/TokenUsageChart.js', () => ({
    TokenUsageChart: ({ config }) => (_jsx("div", { "data-testid": "token-usage-chart", children: config.title })),
}));
vi.mock('../charts/CostBreakdownChart.js', () => ({
    CostBreakdownChart: ({ config }) => (_jsx("div", { "data-testid": "cost-breakdown-chart", children: config.title })),
}));
vi.mock('../charts/UsageTrendsGraph.js', () => ({
    UsageTrendsGraph: ({ config }) => (_jsx("div", { "data-testid": "usage-trends-graph", children: config.title })),
}));
vi.mock('../charts/CostProjectionChart.js', () => ({
    CostProjectionChart: ({ config }) => (_jsx("div", { "data-testid": "cost-projection-chart", children: config.title })),
}));
vi.mock('../components/BudgetAlertsPanel.js', () => ({
    BudgetAlertsPanel: () => (_jsx("div", { "data-testid": "budget-alerts-panel", children: "Alerts Panel" })),
}));
vi.mock('../components/BudgetControlsPanel.js', () => ({
    BudgetControlsPanel: () => (_jsx("div", { "data-testid": "budget-controls-panel", children: "Controls Panel" })),
}));
...
describe('BudgetDashboard', () => {
    ...
    it('should render disabled state when budget is not enabled', () => {
        const { lastFrame } = render(_jsx(BudgetDashboard, { ...defaultProps, budgetSettings: { enabled: false } }));
    ...
    it('should render keyboard shortcuts in footer when not compact', () => {
        const { lastFrame } = render(_jsx(BudgetDashboard, { ...defaultProps, compact: false }));
    ...
    it('should not render footer when compact', () => {
        const { lastFrame } = render(_jsx(BudgetDashboard, { ...defaultProps, compact: true }));
    ...
    it('should handle different initial views', () => {
        ...
        const { lastFrame } = render(_jsx(BudgetDashboard, { ...defaultProps, initialView: "usage" }));
...
describe('BudgetDashboard Chart Utilities', () => {
    it('should use correct progress bar colors based on usage percentage', () => {
        ...
        const { lastFrame: highUsageFrame } = render(_jsx(BudgetDashboard, { ...defaultProps }));
        ...
        const { lastFrame: mediumUsageFrame } = render(_jsx(BudgetDashboard, { ...defaultProps }));
        ...
        const { lastFrame: lowUsageFrame } = render(_jsx(BudgetDashboard, { ...defaultProps }));
