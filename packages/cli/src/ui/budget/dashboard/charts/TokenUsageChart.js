...
export const TokenUsageChart = ({
      ...
      children: [
        ...
        _jsx(Box, {
          ...
          children: _jsx(Text, {
            ...
            children: 'Loading token usage data...',
          }),
        }),
      ],
    });
    ...
    return _jsxs(Box, {
      ...
      children: [
        ...
        _jsx(Box, {
          ...
          children: _jsx(Text, {
            color: theme.text.muted,
            children: 'No token usage data available',
          }),
        }),
      ],
    });
    ...
    _jsxs(Box, {
      ...
      children: [
            ...
            _jsxs(Box, {
              ...
              children: [
                ...
                _jsx(Text, {
                  ...
                  children: formatCompact(totalTokens),
                }),
              ],
            }),
            _jsxs(Box, {
              ...
              children: [
                ...
                _jsx(Text, {
                  color: theme.text.primary,
                  children: formatCompact(avgTokens),
                }),
              ],
            }),
            _jsxs(Box, {
              flexDirection: 'column',
              children: [
                _jsx(Text, { color: theme.text.muted, children: 'Peak' }),
                _jsx(Text, {
                  color: theme.status.warning,
                  children: formatCompact(maxTokens),
                }),
              ],
            }),
            _jsxs(Box, {
              flexDirection: 'column',
              children: [
                _jsx(Text, { color: theme.text.muted, children: 'Low' }),
                _jsx(Text, {
                  color: theme.status.success,
                  children: formatCompact(minTokens),
                }),
              ],
            }),
          ],
        ...
        _jsxs(Box, {
          ...
          alignItems: 'flex-end',
          children: [
            _jsx(Text, { color: theme.text.muted, children: 'Trend' }),
            _jsxs(Text, {
              color: trendColor,
              children: [
                trendDirection === 'increasing'
      ...
      children: [
        ...
        _jsxs(Box, {
          ...
          children: [
            ...
            _jsx(Text, { color: theme.text.muted, children: timeRange }),
            _jsx(Text, {
              color: theme.text.muted,
              children: formatCompact(maxTokens),
            }),
      ...
      children: [
        ...
        _jsxs(Box, {
          ...
          children: [
            _jsx(Text, {
              color: theme.text.muted,
              children: formatTime(visibleData[0]?.timestamp || new Date()),
            }),
            _jsx(Text, {
              color: theme.text.muted,
              children: formatTime(
  ...
  const renderTokenBreakdown = () => {
    ...
    return _jsxs(Box, {
      ...
      marginTop: 1,
      children: [
        _jsx(Text, { color: theme.text.muted, children: 'Token Breakdown:' }),
        _jsxs(Box, {
          gap: 2,
          marginTop: 1,
          children: [
            _jsxs(Text, {
              ...
              children: [
                'Input: ',
                formatCompact(latestMetric.inputTokens),
                ' (',
                inputPct.toFixed(1),
                '%)',
              ],
            ...
            _jsxs(Text, {
              ...
              children: [
                'Output: ',
                formatCompact(latestMetric.outputTokens),
                ' (',
                outputPct.toFixed(1),
                '%)',
              ],
            ...
            _jsxs(Text, {
              ...
              children: [
                'Cached: ',
                formatCompact(latestMetric.cachedTokens),
                ' (',
                cachedPct.toFixed(1),
                '%)',
              ],
  ...
  const renderRecentDataPoints = () => {
    ...
    return _jsxs(Box, {
      ...
      marginTop: 1,
      children: [
        _jsx(Text, { color: theme.text.muted, children: 'Recent Usage:' }),
          ...
          _jsxs(
            Box,
            {
              ...
              children: [
                ...
                _jsxs(Text, {
                  color: theme.text.primary,
                  children: [formatCompact(point.tokens), ' tokens'],
                }),
                point.feature &&
                  _jsx(Text, {
                    color: theme.text.muted,
