...
describe('extensionsCommand', () => {
    ...
    describe('update', () => {
        ...
        it('should update a single extension by name', async () => {
            ...
            mockContext.ui.extensionsUpdateState.set(extension.name, ExtensionUpdateState.UPDATE_AVAILABLE);
            await updateAction(mockContext, 'ext-one');
            expect(mockUpdateExtension).toHaveBeenCalledWith(extension, '/test/dir', ExtensionUpdateState.UPDATE_AVAILABLE, expect.any(Function));
        });
