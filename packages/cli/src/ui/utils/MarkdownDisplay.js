...
const MarkdownDisplayInternal = ({ text, isPending, availableTerminalHeight, terminalWidth, }) => {
    ...
    lines.forEach((line, index) => {
        ...
        if (codeFenceMatch) {
            ...
            switch (level) {
                case 1:
                    headerNode = (_jsx(Text, { bold: true, color: theme.text.link, children: _jsx(RenderInline, { text: headerText }) }));
                    break;
                case 2:
                    headerNode = (_jsx(Text, { bold: true, color: theme.text.link, children: _jsx(RenderInline, { text: headerText }) }));
                    break;
                case 3:
                    headerNode = (_jsx(Text, { bold: true, color: theme.text.primary, children: _jsx(RenderInline, { text: headerText }) }));
                    break;
                case 4:
                    headerNode = (_jsx(Text, { italic: true, color: theme.text.secondary, children: _jsx(RenderInline, { text: headerText }) }));
                    break;
                default:
                    headerNode = (_jsx(Text, { color: theme.text.primary, children: _jsx(RenderInline, { text: headerText }) }));
                    break;
            }
            if (headerNode)
            ...
            if (line.trim().length === 0 && !inCodeBlock) {
                ...
                addContentBlock(_jsx(Box, { children: _jsx(Text, { wrap: "wrap", color: theme.text.primary, children: _jsx(RenderInline, { text: line }) }) }, key));
            }
        }
    });
    if (inCodeBlock) {
