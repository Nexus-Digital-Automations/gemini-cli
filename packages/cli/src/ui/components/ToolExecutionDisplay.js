 ...
 * ```
 */
export const ToolExecutionDisplay = ({
  operation,
  toolCallStatus,
  compact = false,
  showSteps = true,
  ...
  if (compact) {
    return _jsxs(Box, {
      ...
      alignItems: 'center',
      children: [
        _jsxs(Text, { children: [getOperationStatusIndicator(), ' '] }),
        _jsx(Text, {
          color: getStatusColor(toolCallStatus),
          children: operation.context.description,
        }),
        operation.overallProgress > 0 &&
          _jsxs(Text, {
            color: theme.text.secondary,
            children: [' ', '(', operation.overallProgress, '%)'],
          }),
      ],
    });
  }
    ...
    children: [
      ...
      operation.overallProgress > 0 &&
        _jsxs(Box, {
          ...
          children: [
            _jsxs(Text, {
              color: getProgressColor(operation.overallProgress),
              children: [
                createProgressBar(
            ...
            operation.estimatedTimeRemaining &&
              ...
              _jsxs(Text, {
                ...
                children: [
                  ' ',
                  '(~',
                  formatDuration(operation.estimatedTimeRemaining),
                  ' left)',
                ],
              }),
          ],
      ...
      showSteps &&
        ...
        _jsx(Box, {
          marginTop: 1,
          flexDirection: 'column',
          children: operation.steps.map((step, index) => {
      ...
      operation.warnings.length > 0 &&
        _jsx(Box, {
          marginTop: 1,
          flexDirection: 'column',
          children: operation.warnings.map((warning, index) =>
            _jsxs(
              Box,
              {
                flexDirection: 'row',
      ...
      operation.errors.length > 0 &&
        _jsx(Box, {
          marginTop: 1,
          flexDirection: 'column',
          children: operation.errors.map((error, index) =>
            _jsxs(
              Box,
              {
                flexDirection: 'row',
                children: [
                  ...
                  _jsx(Text, { color: theme.status.error, children: error }),
                ],
              },
              index,
            ),
      ...
      showIntermediateResults &&
        operation.intermediateResults.length > 0 &&
        _jsxs(Box, {
          marginTop: 1,
          flexDirection: 'column',
          children: [
      ...
      operation.context.metadata &&
        ...
        _jsx(Box, {
          ...
          children: _jsxs(Text, {
            color: theme.text.muted,
            children: ['Details: ', formatMetadata(operation.context.metadata)],
          }),
        }),
    ],
  });
