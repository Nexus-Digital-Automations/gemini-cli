              ...
              children: [
                ...
                activeOperations.length > 1 &&
                  _jsxs(Text, {
                    ...
                    children: [' ', '(', activeOperations.length, ' active)'],
                  }),
              ],
            }),
            _jsx(Text, { color: theme.text.muted, children: 'Tab to expand' }),
          ],
        }),
        primaryOperation &&
          _jsx(Box, {
  ...
  return _jsxs(Box, {
    ...
    children: [
          ...
          _jsxs(Box, {
            ...
            children: [
              ...
              activeOperations.length > 0 &&
                _jsxs(Text, {
                  color: theme.text.secondary,
                  children: [' ', '(', activeOperations.length, ')'],
                }),
            ],
          }),
          _jsxs(Box, {
            ...
            children: [
              _jsx(Text, {
                ...
                children: 'Tab to collapse',
              }),
              primaryOperation?.canPause &&
                _jsx(Text, {
                  color: theme.text.muted,
                  children: ' \u2022 Space to pause',
                }),
            ...
            _jsxs(Box, {
              ...
              children: [
                _jsx(Text, {
                  color: theme.text.accent,
                  bold: true,
                  children: 'Primary Operation',
                }),
                _jsx(OperationControls, {
                  operation: primaryOperation,
                  onInteraction: handleInteraction,
                }),
              ],
            }),
            _jsx(ToolExecutionDisplay, {
              operation: primaryOperation,
      ...
      activeOperations.length > 1 &&
        _jsxs(Box, {
          ...
          children: [
            ...
            _jsx(MultiProgressBar, {
              operations: activeOperations
                .filter(
                  (op) => op.operationId !== primaryOperation?.operationId,
                )
                .map((op) => ({
                  id: op.operationId,
      ...
      _jsx(Box, {
        ...
        borderTop: true,
        borderColor: theme.ui.comment,
        children: _jsx(ProgressSummary, { operations: activeOperations }),
      }),
    ],
  });
};
  ...
  return _jsxs(Box, {
    ...
    children: [
        ...
        children: [
          ...
          _jsxs(Box, {
            ...
            children: [
              _jsxs(Text, {
                color: theme.text.muted,
                children: ['Elapsed: ', formatDuration(totalElapsed)],
              }),
      ...
      _jsxs(Box, {
        ...
        marginTop: 1,
        children: [
          _jsx(Text, { color: theme.text.secondary, children: 'Status: ' }),
          activeOps.length > 0 &&
            _jsxs(Text, {
              color: theme.text.accent,
              children: [activeOps.length, ' active'],
            }),
