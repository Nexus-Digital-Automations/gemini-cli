...
export const LoadingIndicator = ({
  ...
  return _jsxs(Box, {
    ...
    children: [
        ...
        children: [
          _jsxs(Box, {
            children: [
              ...
              primaryText &&
                _jsx(Text, { color: theme.text.accent, children: primaryText }),
              !isNarrow &&
      ...
      primaryOperation &&
        primaryOperation.overallProgress > 0 &&
        _jsxs(Box, {
          ...
          children: [
            _jsxs(Text, {
              ...
              children: [
                'Progress: ',
                createProgressBar(primaryOperation.overallProgress),
                ' ',
            ...
            primaryOperation.steps.length > 1 &&
              _jsxs(Text, {
                ...
                children: [
                  ' ',
                  '(Step ',
                  primaryOperation.currentStepIndex + 1,
                  ' of',
                  ' ',
      ...
      primaryOperation &&
        ...
        _jsx(Box, {
          ...
          children: _jsx(Text, {
            color: theme.text.muted,
            children: 'Tab for details, Space to pause/resume',
          }),
        }),
      isNarrow &&
        cancelAndTimerContent &&
