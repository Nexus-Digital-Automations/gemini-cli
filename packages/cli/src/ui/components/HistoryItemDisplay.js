...
export const HistoryItemDisplay = ({
  ...
  _jsxs(
    Box,
    {
      ...
      children: [
        item.type === 'user' && _jsx(UserMessage, { text: item.text }),
        item.type === 'user_shell' &&
          _jsx(UserShellMessage, { text: item.text }),
        item.type === 'gemini' &&
          _jsx(GeminiMessage, {
            text: item.text,
            isPending: isPending,
        ...
        item.type === 'error' && _jsx(ErrorMessage, { text: item.text }),
        item.type === 'about' &&
          _jsx(AboutBox, {
        ...
        item.type === 'tool_stats' && _jsx(ToolStatsDisplay, {}),
        item.type === 'quit' &&
          _jsx(SessionSummaryDisplay, { duration: item.duration }),
        ...
        item.type === 'extensions_list' && _jsx(ExtensionsList, {}),
      ],
    },
    item.id,
  );
