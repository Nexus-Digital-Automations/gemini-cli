...
export const BudgetDisplay = ({
  ...
  if (compact) {
    ...
    return _jsxs(Box, {
      ...
      children: [
        _jsxs(Text, {
          color: getUsageColor(),
          children: [requestCount, '/', dailyLimit],
        }),
        _jsxs(Text, {
          color: theme.text.secondary,
          children: [' ', '(', usagePercentage.toFixed(0), '%)'],
        }),
      ],
    });
  }
  ...
  return _jsxs(Box, {
    alignItems: 'center',
    children: [
      _jsx(Text, { color: theme.text.secondary, children: 'budget: ' }),
      _jsxs(Text, {
        color: getUsageColor(),
        children: [requestCount, '/', dailyLimit],
      }),
      _jsx(Text, { color: theme.text.secondary, children: ' [' }),
      _jsx(Text, { color: getUsageColor(), children: createProgressBar(8) }),
      _jsx(Text, { color: theme.text.secondary, children: '] ' }),
      _jsx(Text, {
        color: theme.text.secondary,
        children:
