...
const renderDiffContent = (parsedLines, filename, tabWidth = DEFAULT_TAB_WIDTH, availableTerminalHeight, terminalWidth) => {
    ...
    return (_jsx(MaxSizedBox, { maxHeight: availableTerminalHeight, maxWidth: terminalWidth, children: displayableLines.reduce((acc, line, index) => {
            ...
            if (lastLineNumber !== null &&
                ...
                acc.push(_jsx(Box, { children: _jsx(Text, { wrap: "truncate", color: semanticTheme.text.secondary, children: '═'.repeat(terminalWidth) }) }, `gap-${index}`));
            }
            ...
            acc.push(_jsxs(Box, { flexDirection: "row", children: [_jsxs(Text, { color: semanticTheme.text.secondary, backgroundColor: line.type === 'add'
