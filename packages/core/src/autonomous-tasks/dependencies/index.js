...
export { DependencySequencer, SequencingStrategy, SequencerEvent } from './DependencySequencer.js';
// Unified intelligent dependency management
export { IntelligentDependencyManager, IntelligentDependencyEvent } from './IntelligentDependencyManager.js';
/**
 * Create a fully configured intelligent dependency management system
 * with optimized defaults for autonomous task execution
 */
export function createIntelligentDependencySystem(config) {
 ...
 */
export function createDependencySequencer(config) {
