 ...
 */
import type { DependencyGraph, DependencyNodeId, CircularDependency, DependencyAnalysisResult, CriticalPath, ParallelGroup, GraphValidationStatus } from '../types/Dependency.js';
/**
