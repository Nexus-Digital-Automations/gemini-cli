 ...
 */
export async function createValidationSystem(
    ...
    validatorConfigs: {
      ...
      integration: config.integration
        ? {
            ...
            performanceBenchmarks:
              config.integration.performanceBenchmarks || [],
 ...
 */
export async function createDefaultValidationSystem(): Promise<ValidationSystem> {
