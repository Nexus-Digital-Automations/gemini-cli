...
describe('QualityAssurance', () => {
    ...
    beforeEach(() => {
        ...
        qualityAssurance = new QualityAssurance(mockValidationFramework, mockTaskValidator);
        // Create mock task
        mockTask = {
            id: 'test-task-qa',
    ...
    describe('Initialization', () => {
        ...
        it('should initialize with custom configuration', () => {
            ...
            const customQA = new QualityAssurance(mockValidationFramework, mockTaskValidator, customConfig);
    ...
    describe('Quality Assurance Execution', () => {
        it('should perform comprehensive quality assurance', async () => {
            ...
            const result = await qualityAssurance.performQualityAssurance(mockTask, taskResult, executionMetrics);
        ...
        it('should prevent concurrent quality checks for same task', async () => {
            ...
            const performQualityAssuranceSpy = vi
                .spyOn(qualityAssurance, 'executeComprehensiveQualityCheck')
    ...
    describe('Quality Metrics Collection', () => {
        it('should collect comprehensive quality metrics', async () => {
            ...
            const result = await qualityAssurance.performQualityAssurance(mockTask, undefined, executionMetrics);
            expect(result.metrics).toBeDefined();
    ...
    describe('Quality Check Implementations', () => {
        ...
        describe('Performance Checks', () => {
            it('should validate performance metrics', async () => {
                ...
                const result = await qualityAssurance.performQualityAssurance(mockTask, undefined, goodExecutionMetrics);
            ...
            it('should detect performance violations', async () => {
                ...
                const result = await qualityAssurance.performQualityAssurance(mockTask, undefined, badExecutionMetrics);
        ...
        describe('Reliability Checks', () => {
            it('should validate reliability metrics', async () => {
                ...
                const result = await qualityAssurance.performQualityAssurance(mockTask, successfulTaskResult);
            ...
            it('should detect reliability issues', async () => {
                ...
                const result = await qualityAssurance.performQualityAssurance(mockTask, failedTaskResult, executionMetrics);
    ...
    describe('Alert Generation', () => {
        it('should trigger alerts for critical violations', async () => {
            ...
            await qualityAssurance.performQualityAssurance(mockTask, undefined, criticalExecutionMetrics);
...
describe('QualityAssurance Integration Tests', () => {
    let qualityAssurance;
    let realValidationFramework;
    let realTaskValidator;
    beforeEach(() => {
    ...
    it('should perform end-to-end quality assurance', async () => {
        ...
        const result = await qualityAssurance.performQualityAssurance(task, taskResult, executionMetrics);
        expect(result).toBeDefined();
...
//# sourceMappingURL=QualityAssurance.test.js.map