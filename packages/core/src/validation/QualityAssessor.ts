...
export interface QualityAssessmentCriteria {
  ...
  customCriteria?: Map<
    string,
    (context: QualityAssessmentContext) => Promise<boolean>
  >;
}
...
export class QualityAssessor extends EventEmitter {
  ...
  > = new Map();
  private readonly activeAssessments: Map<
    string,
    Promise<QualityAssessmentResult>
  > = new Map();
  private readonly qualityHistory: Map<string, QualityMetrics[]> = new Map();
  private readonly customAssessors: Map<
    string,
   ...
   */
  private async assessFunctionalQuality(
    context: QualityAssessmentContext,
   ...
   */
  private async assessPerformanceQuality(
    context: QualityAssessmentContext,
  ): Promise<Partial<QualityMetrics>> {
   ...
   */
  private async assessSecurityQuality(
    context: QualityAssessmentContext,
  ): Promise<Partial<QualityMetrics>> {
   ...
   */
  private async assessMaintainabilityQuality(
    context: QualityAssessmentContext,
  ): Promise<Partial<QualityMetrics>> {
   ...
   */
  private async assessReliabilityQuality(
    context: QualityAssessmentContext,
  ): Promise<Partial<QualityMetrics>> {
  ...
  updateAssessmentCriteria(
    level: QualityAssessmentLevel,
    criteria: Partial<QualityAssessmentCriteria>,
  ): void {
