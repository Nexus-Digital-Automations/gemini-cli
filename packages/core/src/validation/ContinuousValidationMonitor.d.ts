...
export declare class ContinuousValidationMonitor extends EventEmitter {
    ...
    constructor(config: Partial<ContinuousValidationMonitorConfig>, validationFramework: ValidationFramework, validationWorkflow: ValidationWorkflow, failureHandler: ValidationFailureHandler, reporting: ValidationReporting);
    startMonitoring(): Promise<void>;
    stopMonitoring(): Promise<void>;
    queueValidation(context: ValidationContext | TaskExecutionContext, trigger: MonitoringTrigger, priority?: number): string;
    triggerValidation(context: ValidationContext | TaskExecutionContext): Promise<string>;
