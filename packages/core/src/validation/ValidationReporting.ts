...
interface ValidationMetrics {
  ...
  validationsByCategory: Record<ValidationCategory, number>;
  validationsBySeverity: Record<ValidationSeverity, number>;
  validationsByStatus: Record<ValidationStatus, number>;
...
interface ReportTemplateData {
  report: ValidationReport | WorkflowExecutionResult;
  summary: {
    totalIssues: number;
...
<body>
   ...
   * Get current metrics
   */
  private async getCurrentMetrics(): Promise<ValidationMetrics> {
    ...
    return {
      ...
      failedValidations: 0,
      averageDuration: 0,
      validationsByCategory: {} as Record<ValidationCategory, number>,
      validationsBySeverity: {} as Record<ValidationSeverity, number>,
      validationsByStatus: {} as Record<ValidationStatus, number>,
      trendsOverTime: [],
      topFailures: [],
      performanceMetrics: {
        p50Duration: 0,
   ...
   */
  private async updateAggregatedReports(): Promise<void> {
