...
export class CodeQualityValidator {
    ...
    async runESLint(context) {
        ...
        try {
            ...
            const filesToLint = context.files?.filter(f => f.endsWith('.ts') || f.endsWith('.tsx') || f.endsWith('.js') || f.endsWith('.jsx')) || [];
    ...
    async runPrettier(context) {
        ...
        try {
            ...
            const filesToCheck = context.files?.filter(f => f.endsWith('.ts') || f.endsWith('.tsx') || f.endsWith('.js') ||
