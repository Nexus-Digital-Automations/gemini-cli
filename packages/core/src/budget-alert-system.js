...
export class BudgetAlertSystem {
     ...
     */
    static createAlert(config, currentValue, currentBudget, recentTrend, varianceDetection, costProjection) {
     ...
     */
    static generateAlertMessage(config, currentValue, thresholdPercentage) {
     ...
     */
    static calculateProjectedImpact(currentBudget, costProjection, thresholdType) {
     ...
     */
    static generateRecommendations(config, currentValue, currentBudget, recentTrend, varianceDetection, costProjection) {
     ...
     */
    static shouldTriggerAlert(config, alert) {
     ...
     */
    static updateAlertSuppression(configId) {
        const now = new Date();
     ...
     */
    static createDefaultAlertConfigs() {
        return [
            {
