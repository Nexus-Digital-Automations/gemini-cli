...
import type { BudgetSettings, MLBudgetRecommendation, PredictionConfidence, ExtendedMLRiskAssessment, ExtendedForecastPoint } from '../types.js';
/**
...
export declare class MLBudgetAPI {
     ...
     */
    getOptimizationSuggestions(request: OptimizationRequest): Promise<OptimizationResponse>;
    /**
     ...
     */
    recordRequest(projectRoot: string, settings: BudgetSettings): Promise<{
        success: boolean;
        error?: string;
    }>;
    /**
     ...
     */
    healthCheck(projectRoot: string, settings: BudgetSettings): Promise<{
        success: boolean;
...
export declare const mlBudgetHandlers: {
     ...
     */
    generateForecast: (req: Request, res: Response, next?: NextFunction) => Promise<Response<any, Record<string, any>>>;
    /**
     * POST /api/budget/ml/optimize
     * Get optimization suggestions
     */
    getOptimizationSuggestions: (req: Request, res: Response, next?: NextFunction) => Promise<Response<any, Record<string, any>>>;
    /**
     * POST /api/budget/ml/anomalies
     * Detect usage anomalies and patterns
     */
    detectAnomalies: (req: Request, res: Response, next?: NextFunction) => Promise<Response<any, Record<string, any>>>;
    /**
     * POST /api/budget/ml/metrics
     * Get ML model performance metrics
     */
    getModelMetrics: (req: Request, res: Response, next?: NextFunction) => Promise<Response<any, Record<string, any>>>;
    /**
     * POST /api/budget/ml/stats
     * Get enhanced usage statistics with ML predictions
     */
    getUsageStats: (req: Request, res: Response, next?: NextFunction) => Promise<Response<any, Record<string, any>>>;
    /**
     * POST /api/budget/ml/record
     * Record a new request
     */
    recordRequest: (req: Request, res: Response, next?: NextFunction) => Promise<Response<any, Record<string, any>>>;
    /**
     * GET /api/budget/ml/health
     * Health check for ML system
     */
    healthCheck: (req: Request, res: Response, next?: NextFunction) => Promise<Response<any, Record<string, any>>>;
};
/**
 * Get the singleton ML Budget API instance
 */
export declare function getMLBudgetAPI(): MLBudgetAPI;
/**
