 ...
 */
import type { HistoricalBudgetRecord, TrendAnalysis, AnomalyDetection, BudgetForecast } from './historical-analysis.js';
/**
...
export declare class HistoricalVisualizationEngine {
     ...
     */
    generateUsageCharts(records: HistoricalBudgetRecord[], config?: Partial<ChartConfig>): Promise<VisualizationArtifact[]>;
    /**
     * Generate trend analysis visualizations
     */
    generateTrendAnalysisCharts(records: HistoricalBudgetRecord[], analysis: TrendAnalysis, config?: Partial<ChartConfig>): Promise<VisualizationArtifact[]>;
    /**
     * Generate forecast visualization
     */
    generateForecastCharts(records: HistoricalBudgetRecord[], forecasts: BudgetForecast[], config?: Partial<ChartConfig>): Promise<VisualizationArtifact[]>;
    /**
     * Generate anomaly detection visualization
     */
    generateAnomalyCharts(records: HistoricalBudgetRecord[], anomalies: AnomalyDetection[], config?: Partial<ChartConfig>): Promise<VisualizationArtifact[]>;
    /**
     * Create comprehensive dashboard
     */
    createDashboard(records: HistoricalBudgetRecord[], analysis: TrendAnalysis, forecasts: BudgetForecast[], anomalies: AnomalyDetection[], widgets?: DashboardWidget[]): Promise<VisualizationArtifact>;
    /**
     * Generate comprehensive historical report
     */
    generateHistoricalReport(records: HistoricalBudgetRecord[], analysis: TrendAnalysis, forecasts: BudgetForecast[], anomalies: AnomalyDetection[], config: ReportConfig): Promise<VisualizationArtifact>;
 ...
 */
export declare function createHistoricalVisualizationEngine(projectRoot: string): HistoricalVisualizationEngine;
