...
export class ChangelogGenerator {
     ...
     */
    renderJSON(entries, releaseNotes, options) {
        const data = {
...
<body>
     ...
     */
    renderXML(entries, releaseNotes, options) {
    ...
    analyzeCommitFrequency(entries) {
    ...
    async compareToPreviousRelease(metrics) {
        return { changeInCommits: '+15%', changeInContributors: '+20%' };
    }
    compareToAverage(metrics) {
    ...
    estimateAffectedUsers(level, entries) {
