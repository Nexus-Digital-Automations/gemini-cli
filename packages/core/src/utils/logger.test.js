...
import { getLogger, getComponentLogger, LogLevel, createTimer, createLoggerConfigFromAppConfig, WinstonStructuredLogger, } from './logger.js';
describe('Structured Logger', () => {
    ...
    beforeEach(() => {
        ...
        console.debug = (...args) => consoleSpy.push({ level: 'debug', args });
        console.info = (...args) => consoleSpy.push({ level: 'info', args });
        console.warn = (...args) => consoleSpy.push({ level: 'warn', args });
        console.error = (...args) => consoleSpy.push({ level: 'error', args });
    });
    afterEach(() => {
    ...
    it('should create config from app config', () => {
        const config = createLoggerConfigFromAppConfig(true, 'session-123', '/custom/logs');
