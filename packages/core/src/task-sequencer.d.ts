 ...
 */
import type { TaskId, Task, ExecutionSequence, ResourceAllocation, TaskQueueConfig } from './types.js';
...
export declare class TaskSequencer {
     ...
     */
    generateExecutionSequence(tasks: Map<TaskId, Task>, algorithm?: 'fifo' | 'priority' | 'dependency_aware' | 'resource_optimal' | 'hybrid'): ExecutionSequence;
    /**
     ...
     */
    generateResourceAllocations(sequence: ExecutionSequence, tasks: Map<TaskId, Task>): ResourceAllocation[];
    /**
     ...
     */
    getResourceUtilization(): Map<string, {
        total: number;
        used: number;
        available: number;
    }>;
