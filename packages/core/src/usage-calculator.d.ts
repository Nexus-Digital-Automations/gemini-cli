 ...
 */
import type { CostCalculationParams, TokenUsageData, ModelUsageData } from '../types.js';
/**
...
export declare class UsageCalculator {
     ...
     */
    calculateCostWithBreakdown(params: CostCalculationParams): Promise<CostBreakdown>;
    /**
     * Analyze usage costs for optimization
     */
    analyzeUsageCosts(tokenUsage: TokenUsageData, modelUsage: Record<string, ModelUsageData>, featureUsage: Record<string, TokenUsageData>, timePeriodHours?: number): UsageCostAnalysis;
    /**
     * Get cost optimization recommendations
     */
    getCostOptimizationRecommendations(analysis: UsageCostAnalysis, modelUsage: Record<string, ModelUsageData>): string[];
    /**
     * Estimate cost for planned usage
     */
    estimateCost(model: string, estimatedInputTokens: number, estimatedOutputTokens: number): Promise<CostBreakdown>;
    /**
 ...
 */
export declare function createUsageCalculator(config?: UsageCalculatorConfig): UsageCalculator;
/**
 * Get or create the global usage calculator instance
 */
export declare function getGlobalUsageCalculator(config?: UsageCalculatorConfig): UsageCalculator;
/**
