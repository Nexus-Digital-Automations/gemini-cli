 ...
 */
export declare function validateCustomFields(fieldValidators: Record<string, (value: unknown) => boolean>): (req: Request, res: Response, next: NextFunction) => void;
/**
 ...
 */
declare function extractValidationData(req: Request, location: ValidationLocation): unknown;
/**
 * Set data in request based on location
 */
declare function setValidationData(req: Request, location: ValidationLocation, data: unknown): void;
/**
 * Get nested property from object
 */
declare function getNestedProperty(obj: unknown, path: string): unknown;
/**
 ...
 */
export declare function composeValidation(...middlewares: Array<(req: Request, res: Response, next: NextFunction) => void>): (req: Request, res: Response, next: NextFunction) => void;
/**
