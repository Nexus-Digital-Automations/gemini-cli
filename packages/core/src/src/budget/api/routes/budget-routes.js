...
export function createBudgetRouter() {
     ...
     */
    router.get('/config/validate', authenticateRequest, validateRequest(configurationRequestSchema, 'query'), configurationController.validateConfigurationEndpoint.bind(configurationController));
