 ...
 */
import type { OptimizationType, FeatureCostAnalysis } from '../analytics/AnalyticsEngine.js';
 ...
 */
export type AllocationStrategy = 'usage_based' | 'roi_optimized' | 'priority_weighted' | 'cost_minimized' | 'performance_balanced' | 'risk_adjusted' | 'capacity_constrained';
/**
