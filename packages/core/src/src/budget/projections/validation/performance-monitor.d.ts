...
export declare class PerformanceMonitor {
     ...
     */
    benchmarkAlgorithm<T>(algorithmName: string, algorithm: (data: CostDataPoint[]) => T, testData: CostDataPoint[]): Promise<PerformanceBenchmark>;
    /**
     ...
     */
    analyzePerformanceTrends(algorithmName: string, timeWindow?: number): PerformanceTrend[];
    /**
     * Detect performance degradation
     */
    detectPerformanceDegradation(algorithmName: string): Promise<DegradationDetection | null>;
    /**
