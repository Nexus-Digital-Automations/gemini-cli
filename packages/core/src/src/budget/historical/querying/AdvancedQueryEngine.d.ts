...
export declare class AdvancedQueryEngine implements QueryEngine {
    ...
    private cacheConfig;
    constructor(storage: TimeSeriesStorage, aggregationEngine: AggregationEngine, baseDir: string);
    /**
 ...
 */
export declare function createAdvancedQueryEngine(storage: TimeSeriesStorage, aggregationEngine: AggregationEngine, baseDir: string): AdvancedQueryEngine;
