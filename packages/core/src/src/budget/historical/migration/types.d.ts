 ...
 */
export type MigrationOperation = 'add_field' | 'remove_field' | 'rename_field' | 'change_type' | 'transform_data' | 'restructure' | 'custom';
/**
 * Migration execution status
 */
export type MigrationStatus = 'pending' | 'running' | 'completed' | 'failed' | 'rolled_back' | 'partial';
/**
...
export interface MigrationEngine {
     ...
     */
    validateData(data: unknown[], version: SchemaVersion): Promise<{
        valid: boolean;
        errors: Array<{
            record: number;
            field: string;
...
export interface MigrationScheduler {
     ...
     */
    scheduleMigration(migrationId: string, scheduledTime: number, options?: {
        recurring?: boolean;
        interval?: number;
        maxRetries?: number;
    }): Promise<string>;
...
export interface CompatibilityChecker {
     ...
     */
    checkVersionCompatibility(fromVersion: SchemaVersion, toVersion: SchemaVersion): Promise<{
        compatible: boolean;
        issues: Array<{
     ...
     */
    analyzeDataReadiness(data: unknown[], targetVersion: SchemaVersion): Promise<{
        ready: boolean;
        statistics: {
            totalRecords: number;
     ...
     */
    previewTransformation(sampleData: unknown[], migration: SchemaMigration): Promise<{
 ...
 */
export type MigrationEventType = 'migration_started' | 'migration_completed' | 'migration_failed' | 'migration_rolled_back' | 'step_started' | 'step_completed' | 'step_failed' | 'batch_processed' | 'backup_created' | 'validation_completed';
/**
...
export type CreateMigrationScheduler = (migrationEngine: MigrationEngine, options?: {
