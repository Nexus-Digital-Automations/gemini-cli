 ...
 * @example
 * ```typescript
 * import { createValidationSystem } from '@google/gemini-cli-core/validation.js';
 *
...
export { ValidationWorkflow, TaskExecutionStage, } from './ValidationWorkflow.js';
// Failure handling exports
export { ValidationFailureHandler, FailureHandlingStrategy, } from './ValidationFailureHandler.js';
...
export async function createValidationSystem(config = {}) {
        ...
        validatorConfigs: {
            ...
            functional: config.functional
                ? {
                    ...
                    testPatterns: config.functional.testPatterns || [
                        '**/*.test.ts',
                        '**/*.spec.ts',
                    ],
    ...
    const monitor = new ContinuousValidationMonitor({
        ...
        ...config.monitoring,
    }, framework, workflow, failureHandler, reporting);
    return {
        framework,
