...
import type { QueueMetrics, AutonomousQueueMetrics } from './EnhancedAutonomousTaskQueue.js';
/**
...
export declare class RealtimeQueueMonitor extends EventEmitter {
     ...
     */
    registerQueue(queueId: string, initialMetrics?: QueueMetrics | AutonomousQueueMetrics): void;
    /**
     ...
     */
    updateQueueMetrics(queueId: string, metrics: QueueMetrics | AutonomousQueueMetrics): void;
    /**
