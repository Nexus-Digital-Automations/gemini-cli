...
export declare abstract class BaseToolInvocation<TParams extends object, TResult extends ToolResult> implements ToolInvocation<TParams, TResult> {
    ...
    constructor(params: TParams, messageBus?: MessageBus, hooksManager?: HooksManager, sessionId?: string, workspaceDir?: string);
     ...
     */
    protected executePreToolUseHooks(): Promise<{
        blocked: boolean;
        message?: string;
     ...
     */
    protected executePostToolUseHooks(result: TResult): Promise<void>;
...
export declare abstract class DeclarativeTool<TParams extends object, TResult extends ToolResult> implements ToolBuilder<TParams, TResult> {
    ...
    constructor(name: string, displayName: string, description: string, kind: Kind, parameterSchema: unknown, isOutputMarkdown?: boolean, canUpdateOutput?: boolean, messageBus?: MessageBus, hooksManager?: HooksManager, sessionId?: string, workspaceDir?: string);
...
export declare abstract class BaseDeclarativeTool<TParams extends object, TResult extends ToolResult> extends DeclarativeTool<TParams, TResult> {
    ...
    protected abstract createInvocation(params: TParams, messageBus?: MessageBus, hooksManager?: HooksManager, sessionId?: string, workspaceDir?: string): ToolInvocation<TParams, TResult>;
}
/**
