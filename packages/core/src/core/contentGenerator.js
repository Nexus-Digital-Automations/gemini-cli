...
export async function createContentGenerator(config, gcConfig, sessionId, budgetSettings) {
    ...
    if (config.authType === AuthType.LOGIN_WITH_GOOGLE ||
        ...
        const loggingGenerator = new LoggingContentGenerator(await createCodeAssistContentGenerator(httpOptions, config.authType, gcConfig, sessionId), gcConfig);
