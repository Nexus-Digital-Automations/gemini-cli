...
export class FileStorage {
    ...
    async readUsageData() {
        ...
        try {
            ...
            this.logger.error('Failed to read usage data', { error: error });
            return {
                success: false,
    ...
    async createBackup() {
        ...
        try {
            ...
            this.logger.error('Failed to create backup', { error: error });
            return {
                success: false,
        ...
        if (typeListeners) {
            for (const listener of typeListeners) {
                try {
                    ...
                    this.logger.warn('Event listener error', { error: error });
                }
            }
        }
