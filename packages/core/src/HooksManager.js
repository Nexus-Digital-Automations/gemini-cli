...
export class HooksManager {
     ...
     */
    static getModifiedInput(results) {
        const modification = results.find((r) => r.success && r.response?.modify?.tool_input);
