...
describe('AgentCoordinator', () => {
  ...
  describe('Agent Assignment', () => {
    ...
    it('should return null when no suitable agent available', async () => {
      const taskWithSpecificCapabilities: AutonomousTask = {
        ...mockTask,
    ...
    it('should handle agent with maximum load', async () => {
      const busyAgent: RegisteredAgent = {
        ...mockAgent,
  ...
  describe('Load Balancing', () => {
    it('should rebalance workload between agents', async () => {
      ...
      const overloadedAgent: RegisteredAgent = {
        ...mockAgent,
        id: 'overloaded-agent',
        currentTasks: ['task-1', 'task-2', 'task-3'],
        status: 'busy',
      ...
      const underloadedAgent: RegisteredAgent = {
        ...mockAgent,
      ...
      const overloadedMetrics: AgentMetrics = {
        id: 'overloaded-agent',
      ...
      const underloadedMetrics: AgentMetrics = {
        id: 'underloaded-agent',
  ...
  describe('Communication', () => {
    it('should establish communication between agents', async () => {
      ...
      const channels = (coordinator as any).communicationChannels;
  ...
  describe('System Status', () => {
    ...
    it('should calculate performance metrics correctly', async () => {
      const highPerformanceAgent: RegisteredAgent = {
        ...mockAgent,
        performance: {
          completedTasks: 100,
  ...
  describe('Error Handling', () => {
    ...
    it('should handle task assignment to non-existent agent', async () => {
      const nonExistentAgent: RegisteredAgent = {
        ...mockAgent,
        id: 'non-existent',
      };
  ...
  describe('Event Emission', () => {
    ...
    it('should emit events during load balancing', async () => {
      ...
      (coordinator as any).agentMetrics.set(mockAgent.id, {
  ...
  describe('Performance Optimization', () => {
    it('should select agent based on performance metrics', async () => {
      const lowPerformanceAgent: RegisteredAgent = {
        ...mockAgent,
        id: 'low-perf',
        performance: {
          completedTasks: 5,
    ...
    it('should consider current load in agent selection', async () => {
      const availableAgent: RegisteredAgent = {
        ...mockAgent,
        id: 'available',
        currentTasks: [],
        status: 'idle',
