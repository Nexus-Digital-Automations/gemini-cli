...
describe('AgentCommunicationHub', () => {
  ...
  describe('Message Routing and Filtering', () => {
    ...
    it('should filter messages based on content', () => {
      const filter = (message: AgentMessage) => message.priority === 'high';
      communicationHub.addMessageFilter('high-priority-filter', filter);

      const highPriorityMessage: AgentMessage = {
        id: 'high-msg',
        senderId: 'agent-1',
        recipientId: 'agent-2',
        type: 'urgent_task',
    ...
    it('should handle message transformation', () => {
      const transformer = (message: AgentMessage) => ({
        ...message,
  ...
  describe('Performance Optimization', () => {
    ...
    it('should compress large messages', () => {
      const largeMessage: AgentMessage = {
        id: 'large-msg',
        senderId: 'agent-1',
        recipientId: 'agent-2',
        type: 'large_dataset',
