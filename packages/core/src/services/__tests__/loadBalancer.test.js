...
// Mock agents
const createMockAgent = (id, currentLoad = 0, maxCapacity = 10) => ({
    id,
...
describe('LoadBalancer', () => {
    ...
    describe('Predictive Load Balancing', () => {
        ...
        it('should recommend optimal agent based on predictions', async () => {
            ...
            const recommendation = await loadBalancer.getOptimalAgentRecommendation(mockAgents, mockHighPriorityTask);
    ...
    describe('Error Handling and Edge Cases', () => {
        ...
        it('should handle null task gracefully', async () => {
            const agent = await loadBalancer.selectAgent(mockAgents, null);
            expect(agent).toBeNull();
        });
