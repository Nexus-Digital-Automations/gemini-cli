...
import { TaskStatus, TaskCategory, TaskType, TaskComplexity, TaskPriority, } from './types.js';
            ...
            metrics: data.metrics
                ? {
                    ...
                    endTime: data.metrics.endTime
                        ...
                        : undefined,
                    durationMs: Number(data.metrics.durationMs) || 0,
                    tokenUsage: Number(data.metrics.tokenUsage) || 0,
                    toolCallsCount: Number(data.metrics.toolCallsCount) || 0,
                    subAgentCount: Number(data.metrics.subAgentCount) ||
                        0,
                    errorCount: Number(data.metrics.errorCount) || 0,
                    retryCount: Number(data.metrics.retryCount) || 0,
                }
                : undefined,
        };
    }
