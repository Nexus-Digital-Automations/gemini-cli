...
export declare function updateAutonomousTaskConfig(updates: Partial<AutonomousTaskSettings>): void;
export declare function getIntegrationConfig(): IntegrationConfig;
export declare function watchConfigChanges(callback: (config: AutonomousTaskSettings) => void): () => void;
