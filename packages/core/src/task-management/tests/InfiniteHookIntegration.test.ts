...
describe('InfiniteHookIntegration', () => {
  let integration: InfiniteHookIntegration;
  let taskEngine: TaskExecutionEngine;
  let monitoring: ExecutionMonitoringSystem;
  ...
  describe('Initialization', () => {
    it('should initialize successfully with valid configuration', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        expect.stringContaining('/register-agent'),
  ...
  describe('FEATURES.json Monitoring', () => {
    it('should create tasks from approved features', async () => {
      ...
      expect(taskEngine.queueTask).toHaveBeenCalledWith(
    ...
    it('should handle missing FEATURES.json gracefully', async () => {
      (mockConfig.storage!.fileExists as any).mockResolvedValueOnce(false);
  ...
  describe('Progress Reporting', () => {
    it('should report progress to task manager API', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        expect.stringContaining('/report-progress'),
        expect.objectContaining({
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
    ...
    it('should handle progress reporting failure gracefully', async () => {
      (taskEngine.getAllTasks as any).mockReturnValueOnce([]);
