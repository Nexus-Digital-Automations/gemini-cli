...
describe('QueueOptimizer', () => {
  ...
  let mockDependencyAnalysis: DependencyAnalysis;
  let mockMetrics: QueueMetrics;
  ...
  describe('Resource Allocation Optimization', () => {
    it('should optimize resource allocation', () => {
      const allocation = optimizer.optimizeResourceAllocation(
        mockTasks,
        mockDependencyAnalysis,
        {
          cpu: 100,
  ...
  describe('Error Handling and Edge Cases', () => {
    it('should handle empty task queue gracefully', () => {
      const emptyTasks = new Map<string, Task>();
    ...
    it('should handle tasks without resource requirements', () => {
      const taskWithoutResources: Task = {
        id: 'no-resources',
