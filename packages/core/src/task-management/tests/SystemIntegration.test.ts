...
describe('Task Management System Integration Tests', () => {
  ...
  let integrator: TaskManagementSystemIntegrator | null = null;
  let configManager: TaskManagementConfigManager | null = null;
  ...
  describe('Error Handling and Recovery Integration', () => {
    it('should handle initialization errors gracefully', async () => {
      ...
      config.core = {} as Config; // Invalid core config
