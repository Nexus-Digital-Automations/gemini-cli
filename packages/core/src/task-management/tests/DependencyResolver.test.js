...
describe('DependencyResolver', () => {
    ...
    describe('Cycle Detection', () => {
        ...
        it('should detect complex cycle (A -> B -> C -> A)', () => {
            ...
            expect(cycles[0].cycle).toEqual(expect.arrayContaining([tasks[0].id, tasks[1].id, tasks[2].id]));
        });
    ...
    describe('Ready Tasks Identification', () => {
        it('should identify all tasks as ready when no dependencies exist', () => {
            ...
            expect(readyTasks.map((t) => t.id)).toEqual(expect.arrayContaining(tasks.map((t) => t.id)));
        });
    ...
    describe('Parallel Execution Groups', () => {
        it('should identify parallel execution groups correctly', () => {
            ...
            expect(parallelGroups[1]).toEqual(expect.arrayContaining([tasks[1].id, tasks[2].id]));
            // Group 3: [D]
