...
export class TestFactories {
    ...
    static createMockTasks(count, baseOverrides = {}) {
        ...
        const categories = ['implementation', 'testing', 'documentation', 'analysis', 'refactoring', 'deployment'];
        const statuses = ['pending', 'ready', 'in_progress', 'completed', 'failed', 'blocked'];
