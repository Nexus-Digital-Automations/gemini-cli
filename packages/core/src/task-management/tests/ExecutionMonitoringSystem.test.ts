...
describe('ExecutionMonitoringSystem', () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    monitoring = new ExecutionMonitoringSystem(mockConfig as Config);
  });
  ...
  describe('Event Recording', () => {
    ...
    it('should record events with duration and error information', () => {
      const completedEvent: TaskExecutionEvent = {
        taskId: 'test-task-123',
        eventType: 'completed',
  ...
  describe('System Health Monitoring', () => {
    it('should report healthy system status', () => {
      const healthyMetrics: ExecutionMetrics = {
        totalTasks: 10,
        runningTasks: 2,
        completedTasks: 7,
        failedTasks: 1,
    ...
    it('should report critical system status when performance is poor', () => {
      const criticalMetrics: ExecutionMetrics = {
        totalTasks: 10,
        runningTasks: 0,
        completedTasks: 2,
        failedTasks: 8,
...
function createMockTasksForTesting(): Task[] {
  const now = new Date();
