...
declare class PerformanceTestRunner {
    ...
    constructor();
    runPerformanceTest(queue: SelfManagingTaskQueue, config: PerformanceTestConfig): Promise<PerformanceTestResult>;
    validatePerformanceResult(result: PerformanceTestResult, config: PerformanceTestConfig): {
        passed: boolean;
        issues: string[];
    };
    clear(): void;
