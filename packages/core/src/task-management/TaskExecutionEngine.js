...
(function (TaskComplexity) {
    ...
    TaskComplexity["ENTERPRISE"] = "enterprise"; // Highly complex, extensive coordination
...
(function (TaskStatus) {
    ...
    TaskStatus["CANCELLED"] = "cancelled"; // Cancelled by user or system
...
(function (TaskPriority) {
    ...
    TaskPriority["LOW"] = "low"; // Nice-to-have, cleanup tasks
...
(function (TaskType) {
    ...
    TaskType["PERFORMANCE"] = "performance"; // Performance optimization
})(TaskType || (TaskType = {}));
/**
...
(function (DependencyType) {
    ...
    DependencyType["VALIDATION"] = "validation"; // Validation dependency
