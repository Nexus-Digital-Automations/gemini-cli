...
export class TaskManagementSystemIntegrator {
    ...
    async initialize() {
        try {
            ...
            if (this.config.persistence?.enabled !== false) {
                ...
                this.persistence = new CrossSessionPersistenceEngine(this.config.persistence?.storageLocation || '.task-management-data', {
    ...
    getSystemHealth() {
        ...
        return {
            ...
            metrics: {
                ...
                taskThroughput: metrics.completedTasks /
    ...
    getSystemStatus() {
        ...
        const monitoringMetrics = this.monitoring?.getSystemHealth(this.monitoring.collectMetrics(this.taskEngine?.getAllTasks() || []));
        return {
            health,
            taskEngineStats,
