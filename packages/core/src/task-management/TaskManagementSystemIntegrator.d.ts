...
export declare class TaskManagementSystemIntegrator {
     ...
     */
    queueTask(title: string, description: string, options?: Record<string, unknown> & {
    ...
    getSystemStatus(): Promise<{
        health: SystemHealth;
        taskEngineStats: Record<string, unknown>;
        autonomousQueueStatus: import("./EnhancedAutonomousTaskQueue.js").AutonomousQueueMetrics;
        monitoringMetrics: import("./ExecutionMonitoringSystem.js").SystemHealthStatus;
        components: {
            taskEngine: boolean;
