...
export declare class TaskManagementSystemIntegrator {
  ...
  getSystemStatus(): {
    ...
    autonomousQueueStatus:
      | import('./EnhancedAutonomousTaskQueue.js').AutonomousQueueMetrics
      | undefined;
    monitoringMetrics:
      | import('./ExecutionMonitoringSystem.js').SystemHealthStatus
      | undefined;
    components: {
      taskEngine: boolean;
 ...
 */
export declare function createIntegratedTaskManagementSystem(
