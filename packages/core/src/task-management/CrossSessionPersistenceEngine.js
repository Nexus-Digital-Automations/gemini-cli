...
import { FileBasedTaskStore, CompressionAlgorithm, SerializationFormat, } from '../autonomous-tasks/persistence/FileBasedTaskStore.js';
/**
    ...
    async flushWriteBuffer() {
        ...
        try {
            for (const [taskId, { data }] of bufferedTasks) {
                await super.saveTask(data, transaction);
            }
            await this.commitTransaction(transaction);
        }
        catch (error) {
...
class DataIntegrityManager {
    ...
    getValidationsPassed() { return this.validationsPassed; }
    getCorruptionsDetected() { return this.corruptionsDetected; }
    getCorruptionsFixed() { return this.corruptionsFixed; }
    getIntegrityStats() {
        return {
...
class PerformanceOptimizer {
    ...
    initializeOptimizationRules() {
        ...
        this.optimizationRules.set('batch_operations', {
            ...
            shouldApply: async (operationName, data) => {
