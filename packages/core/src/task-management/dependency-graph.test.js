...
describe('DependencyGraphManager', () => {
    ...
    describe('Circular Dependency Detection', () => {
        ...
        test('should generate resolution strategies for circular dependencies', () => {
            ...
            const softRemovalStrategy = cycles[0].resolutionStrategies.find((s) => s.strategy === 'remove_edge' && s.impact === 'low');
...
function createTestTask(id, title, category, priority, estimatedDuration) {
    const now = new Date();
    return {
        id,
        title,
