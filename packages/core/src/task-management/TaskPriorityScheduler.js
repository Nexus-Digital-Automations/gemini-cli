...
(function (PriorityStrategy) {
    ...
    PriorityStrategy["HYBRID"] = "hybrid"; // Combination of multiple strategies
...
(function (StarvationPreventionMode) {
    ...
    StarvationPreventionMode["ADAPTIVE_BOOST"] = "adaptive_boost"; // Intelligently boost starving tasks
