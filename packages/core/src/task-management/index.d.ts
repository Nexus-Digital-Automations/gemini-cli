...
export { TaskComplexity, TaskStatus, TaskPriority, TaskType, DependencyType, AgentCapability, SubagentTerminateMode, ContextState, } from './TaskExecutionEngine.js';
export type { Task, TaskDependency, TaskBreakdown, TaskMetrics, TaskExecutionContext, TaskBreakdownAnalyzer, } from './TaskExecutionEngine.js';
...
export type { TaskManagementConfiguration, TaskEngineConfig, AutonomousQueueConfig, MonitoringConfig, PersistenceConfig, DependencyConfig, SecurityConfig, DevelopmentConfig, ConfigValidationResult, } from './TaskManagementConfig.js';
...
export type { ExecutionMetrics, TaskExecutionEvent, AlertConfig, BottleneckAnalysis, SystemHealthStatus, } from './ExecutionMonitoringSystem.js';
 ...
 */
export declare function createTaskManagementSystem(config: Config, options?: Record<string, unknown>): Promise<import("./TaskManager.js").TaskManager>;
/**
 ...
 */
export declare function createCompleteWithAutonomousQueue(config: Config, queueConfig?: Partial<EnhancedQueueConfig>, options?: Record<string, unknown>): Promise<{
    taskEngine: TaskExecutionEngine;
    autonomousQueue: EnhancedAutonomousTaskQueue;
    monitoring?: ExecutionMonitoringSystem;
    hookIntegration?: InfiniteHookIntegration;
