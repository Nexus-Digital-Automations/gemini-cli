...
import type {
  EnhancedAutonomousTaskQueue} from './EnhancedAutonomousTaskQueue.js';
import {
  type EnhancedQueueConfig,
} from './EnhancedAutonomousTaskQueue.js';
/**
...
export declare class TaskManagementSystemFactory {
   ...
   */
  static createCompleteWithAutonomousQueue(
    config: Config,
 ...
 */
export declare function createTaskManagementSystem(
  config: Config,
  options?: any,
): Promise<any>;
/**
 ...
 */
export declare function createAutonomousTaskQueue(
  config?: Partial<EnhancedQueueConfig>,
): EnhancedAutonomousTaskQueue;
/**
 * Convenience function to create complete system with autonomous queue
 */
export declare function createCompleteWithAutonomousQueue(
  config: Config,
  queueConfig?: Partial<EnhancedQueueConfig>,
  options?: any,
): Promise<{
