...
export declare class ContextSystem {
  ...
  getSuggestions(
    ...
    suggestionType?: 'command' | 'code' | 'workflow' | 'optimization' | 'debug',
 ...
 */
export declare function createContextSystem(
 ...
 */
export declare function createDevelopmentContextSystem(
  projectPath: string,
): Promise<ContextSystem>;
/**
 * Factory function to create a pre-configured context system for production
 */
export declare function createProductionContextSystem(
  projectPath: string,
): Promise<ContextSystem>;
