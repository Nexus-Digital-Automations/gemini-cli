...
export { SuggestionEngine, createSuggestionEngine, DEFAULT_SUGGESTION_ENGINE_CONFIG, } from './SuggestionEngine.js';
...
import type { ContextItem, ContextSuggestion, SessionContext, ContextWindow, PrioritizationConfig, CompressionConfig } from './types.js';
import type { StorageConfig } from './CrossSessionStorage.js';
import type { AllocationStats, ContextWindowConfig } from './ContextWindowManager.js';
import type { AnalysisStats, CodeAnalysisConfig } from './CodeContextAnalyzer.js';
...
export declare class ContextSystem {
     ...
     */
    addContext(item: ContextItem, section?: 'system' | 'conversation' | 'code' | 'project' | 'memory'): Promise<boolean>;
    /**
