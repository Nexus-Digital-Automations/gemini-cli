 ...
 */
import type { ContextWindow, ContextSuggestion, ContextAnalysis, ContextType } from './types.js';
import type { PrioritizationConfig, CompressionConfig, UserInteraction } from './types.js';
...
export declare class AdvancedContextRetentionSystem {
     ...
     */
    addContext(type: ContextType, content: string, metadata?: Record<string, unknown>): Promise<string>;
    /**
