...
export declare class SemanticCompressor {
     ...
     */
    batchCompress(items: ContextItem[], targetRatio?: number): Promise<Map<string, CompressionResult>>;
    /**
 ...
 */
export declare function createSemanticCompressor(config?: Partial<CompressionConfig>): SemanticCompressor;
