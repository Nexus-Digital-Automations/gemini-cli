...
export declare class BudgetAccessControl {
     ...
     */
    checkPermissions(context: BudgetSecurityContext, requiredPermissions: BudgetPermission[], resource: string, action: string): Promise<PermissionCheckResult>;
    /**
 ...
 */
export declare function createBudgetAccessControl(config?: Partial<SecurityConfig>): BudgetAccessControl;
