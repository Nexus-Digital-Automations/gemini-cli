...
export class BudgetEventSystem {
    ...
    createEmitters() {
        return {
             ...
             */
            warningThreshold: (data) => this.emit({
             ...
             */
            settingsChanged: (data) => this.emit({
    ...
    getStatistics() {
        ...
        return {
            ...this.statistics,
            averageEventsPerMinute: runtimeMinutes > 0 ? this.statistics.totalEvents / runtimeMinutes : 0,
        };
    }
    /**
