...
import type { StorageOperationResult, StorageHealthCheck, StorageMetrics, ObservableStorage, StorageEvent, StorageEventType, StorageEventListener } from './BudgetStorageInterface.js';
/**
