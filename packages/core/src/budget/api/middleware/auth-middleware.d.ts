 ...
 */
export declare function requirePermissions(requiredPermissions: BudgetPermission[]): (req: AuthenticatedRequest, res: Response, next: NextFunction) => void;
/**
 * Role-based authorization middleware
 */
export declare function requireRoles(requiredRoles: string[]): (req: AuthenticatedRequest, res: Response, next: NextFunction) => void;
/**
 ...
 */
declare function validateCredentials(credentials: string, type: 'bearer' | 'apikey' | 'basic'): UserAuthData | null;
/**
 * Generate session ID
 */
 ...
 */
export declare function logAuthEvents(req: AuthenticatedRequest, res: Response, next: NextFunction): void;
/**
 * Development-only middleware to bypass authentication
 * WARNING: Only use in development environment
 */
export declare function devBypassAuth(req: AuthenticatedRequest, res: Response, next: NextFunction): void;
/**
