 ...
 */
export declare function auditLogMiddleware(
  req: AuditRequest,
  res: Response,
  next: NextFunction,
): void;
...
export declare function auditSecurityEvent(
  ...
  severity: EventSeverity,
  details: Record<string, any>,
): (req: AuditRequest, res: Response, next: NextFunction) => void;
/**
 * Data access audit middleware
 */
export declare function auditDataAccess(
  dataType: string,
): (req: AuditRequest, res: Response, next: NextFunction) => void;
/**
 * Configuration change audit middleware
 */
export declare function auditConfigChange(
  req: AuditRequest,
  res: Response,
  next: NextFunction,
): void;
 ...
 */
export declare function auditExportImport(
...
declare function filterSensitiveHeaders(
