 ...
 */
export declare function userRateLimit(
  config?: Partial<RateLimitConfig>,
): (req: Request, res: Response, next: NextFunction) => void;
/**
 ...
 */
export declare function endpointRateLimit(
  config?: Partial<RateLimitConfig>,
): (req: Request, res: Response, next: NextFunction) => void;
/**
 * Global rate limiting middleware (applies to all requests)
 */
export declare function globalRateLimit(
  config?: Partial<RateLimitConfig>,
): (req: Request, res: Response, next: NextFunction) => void;
/**
 * Burst protection middleware (short window, low limit)
 */
export declare function burstProtection(): (
  req: Request,
  res: Response,
  next: NextFunction,
) => void;
 ...
 */
declare function setRateLimitHeaders(
  res: Response,
 ...
 */
export declare function bypassRateLimit(
  req: Request,
  res: Response,
  next: NextFunction,
): void;
