...
export class AnalyticsController {
            ...
            const response = {
                ...
                data: {
                    ...
                    summary: {
                        ...
                        averageCostPerRequest: enrichedBreakdown.totalCost /
    ...
    enrichBreakdownData(breakdown) {
        ...
        const totalCost = breakdown.categories.reduce((sum, cat) => sum + (cat.cost || 0), 0);
        const totalRequests = breakdown.categories.reduce((sum, cat) => sum + (cat.requests || 0), 0);
