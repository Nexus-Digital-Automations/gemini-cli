...
import { BudgetSettings, BudgetUsageData, BudgetPermission } from '../../types.js';
...
export const openApiSpec = {
  ...
  info: {
    ...
    description: 'Comprehensive REST API for budget tracking, analytics, and management',
    version: '1.0.0',
    contact: {
  ...
  components: {
    ...
    schemas: {
      ...
      BudgetUsageData: {
        ...
        required: ['date', 'requestCount', 'totalCost', 'lastResetTime', 'warningsShown']
      },
      ApiResponse: {
        type: 'object',
        properties: {
  ...
  paths: {
    ...
    '/usage': {
      get: {
        ...
        description: 'Retrieve current budget usage data with optional filtering',
        tags: ['Usage'],
        parameters: [
          {
            name: 'projectRoot',
                    ...
                    { $ref: '#/components/schemas/ApiResponse' },
                    {
                      properties: {
                        data: {
                          type: 'object',
                          properties: {
                            current: { $ref: '#/components/schemas/BudgetUsageData' },
                            mlPredictions: {
                              type: 'object',
                              description: 'ML-enhanced predictions and analytics'
                            }
                          }
                        }
                      }
    ...
    '/usage/history': {
      get: {
        ...
        description: 'Retrieve historical usage data with pagination and filters',
        tags: ['Usage'],
        parameters: [
          {
            name: 'startDate',
                    ...
                    { $ref: '#/components/schemas/ApiResponse' },
                    {
                      properties: {
                        data: {
                          type: 'object',
                          properties: {
                            configuration: { $ref: '#/components/schemas/BudgetSettings' }
                          }
                        }
                      }
                    }
    ...
    '/export': {
      get: {
        ...
        description: 'Export budget data in specified format (JSON, CSV, Excel, PDF)',
        tags: ['Export/Import'],
        parameters: [
          {
            name: 'format',
    ...
    '/stream': {
      get: {
        ...
        description: 'Establish WebSocket connection for real-time budget updates',
        tags: ['Streaming'],
        responses: {
          '101': {
...
export const apiDocumentation = {
  ...
  version: '1.0.0',
  description: 'Complete documentation for the Budget Management API with examples and usage patterns.',
          ...
          example: {
            ...
            response: {
              ...
              data: {
                ...
                mlPredictions: {
                  dailyForecast: [
                    { timestamp: '2025-01-15T14:00:00.000Z', predictedCost: 55.20 }
                  ],
                  recommendations: [
                    {
                      type: 'cost_optimization',
                      description: 'Consider using smaller models for simple queries',
        ...
        },
        {
          ...
          parameters: {
            query: {
              ...
              limit: 'number (1-1000) - Maximum records to return (default: 50)',
              offset: 'number - Records to skip (default: 0)',
              granularity: 'enum [hour,day,week,month] - Data granularity (default: day)'
            }
          },
          example: {
            request: 'GET /api/budget/usage/history?startDate=2025-01-01T00:00:00Z&endDate=2025-01-15T23:59:59Z&granularity=day',
            response: {
              success: true,
              data: {
                history: [
      ...
      endpoints: [
        ...
        },
        {
          ...
          requestBody: {
            ...
            warningThresholds: 'number[] - Warning thresholds as percentages (0-100)'
          },
          example: {
            request: {
              enabled: true,
  ...
  websocketApi: {
    ...
    authentication: 'Include authentication in connection headers or query parameters',
    messageTypes: {
      usage_update: {
