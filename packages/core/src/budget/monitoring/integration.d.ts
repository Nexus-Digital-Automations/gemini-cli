...
export declare class TokenMonitoringIntegration extends EventEmitter {
  ...
  constructor(
    ...
    integrationConfig: MonitoringIntegrationConfig,
  );
  /**
 ...
 */
export declare function createTokenMonitoringIntegration(
  config: Config,
  budgetSettings: BudgetSettings,
 ...
 */
export declare function createMonitoringEnabledContentGenerator(
