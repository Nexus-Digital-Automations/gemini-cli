 ...
 */
export declare function createBudgetEventManager(config?: EventHistoryConfig): BudgetEventManager;
/**
 * Get or create the global event manager instance
 */
export declare function getGlobalEventManager(config?: EventHistoryConfig): BudgetEventManager;
/**
 ...
 */
export declare function createBudgetEvent(type: BudgetEventType, source: string, data: Record<string, any>, severity?: EventSeverity): BudgetEvent;
