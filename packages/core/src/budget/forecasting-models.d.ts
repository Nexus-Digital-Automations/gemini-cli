 ...
 */
import type { HistoricalBudgetRecord, BudgetForecast } from './historical-analysis.js';
/**
...
export declare class BudgetForecastingEngine {
     ...
     */
    generateEnsembleForecast(historicalRecords: HistoricalBudgetRecord[], targetDate: string, scenarios?: ScenarioConfig[], monteCarloConfig?: Partial<MonteCarloConfig>): Promise<EnsembleForecast>;
    /**
