...
import type { BudgetSettings, BudgetUsageData, BudgetValidationResult, BudgetCalculationContext } from '../types.js';
...
export declare class BudgetConstraintViolation extends Error {
    ...
    constructor(message: string, constraint: string, currentValue: number, limitValue: number, severity: 'warning' | 'error' | 'critical');
}
/**
...
export declare class BudgetValidator {
     ...
     */
    validateBudgetConstraints(settings: BudgetSettings, usageData: BudgetUsageData, costCalculation?: CostCalculationResult, context?: BudgetCalculationContext): Promise<ComprehensiveValidationResult>;
    /**
     ...
     */
    quickValidate(settings: BudgetSettings, usageData: BudgetUsageData, proposedCost?: number): Promise<BudgetValidationResult>;
    /**
