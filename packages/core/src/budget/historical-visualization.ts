...
export class HistoricalVisualizationEngine {
   ...
   */
  async generateTrendAnalysisCharts(
    records: HistoricalBudgetRecord[],
  ...
  private async createDailyUsageChart(
    records: HistoricalBudgetRecord[],
    config: ChartConfig,
  ): Promise<VisualizationArtifact> {
  ...
  private async createWeeklyPatternChart(
    records: HistoricalBudgetRecord[],
    config: ChartConfig,
  ): Promise<VisualizationArtifact> {
  ...
  private async createUsageHeatmap(
    records: HistoricalBudgetRecord[],
    config: ChartConfig,
  ): Promise<VisualizationArtifact> {
    // Create heatmap data structure
    const heatmapData: { [month: string]: { [day: string]: number } } = {};
  ...
  private async createEfficiencyChart(
    records: HistoricalBudgetRecord[],
    config: ChartConfig,
  ): Promise<VisualizationArtifact> {
    const series: ChartSeries[] = [
  ...
  private async createTrendDecompositionChart(
    records: HistoricalBudgetRecord[],
    analysis: TrendAnalysis,
    config: ChartConfig,
  ): Promise<VisualizationArtifact> {
  ...
  private async createSeasonalPatternChart(
    analysis: TrendAnalysis,
    config: ChartConfig,
  ): Promise<VisualizationArtifact> {
  ...
  private async createVolatilityChart(
    records: HistoricalBudgetRecord[],
    analysis: TrendAnalysis,
    config: ChartConfig,
  ): Promise<VisualizationArtifact> {
  ...
  private async createForecastTimelineChart(
    records: HistoricalBudgetRecord[],
    forecasts: BudgetForecast[],
    config: ChartConfig,
  ): Promise<VisualizationArtifact> {
  ...
  private async createConfidenceIntervalChart(
    forecasts: BudgetForecast[],
    config: ChartConfig,
  ): Promise<VisualizationArtifact> {
  ...
  private async createScenarioComparisonChart(
    forecasts: BudgetForecast[],
    config: ChartConfig,
  ): Promise<VisualizationArtifact> {
  ...
  private async createAnomalyTimelineChart(
    records: HistoricalBudgetRecord[],
    anomalies: AnomalyDetection[],
    config: ChartConfig,
  ): Promise<VisualizationArtifact> {
  ...
  private async createAnomalySeverityChart(
    anomalies: AnomalyDetection[],
    config: ChartConfig,
  ): Promise<VisualizationArtifact> {
  ...
  private async createAnomalyScoreChart(
    anomalies: AnomalyDetection[],
    config: ChartConfig,
  ): Promise<VisualizationArtifact> {
  ...
  private generateSvgChart(series: ChartSeries[], config: ChartConfig): string {
  ...
  private generateHeatmapSvg(
    data: { [month: string]: { [day: string]: number } },
    config: ChartConfig,
  ): string {
...
<body>
  ...
  private calculateSummaryStats(records: HistoricalBudgetRecord[]): {
    totalUsage: number;
    averageUsage: number;
    peakUsage: number;
    efficiency: number;
  ...
  private async saveToDisk(artifact: VisualizationArtifact): Promise<void> {
    try {
 ...
 */
export function createHistoricalVisualizationEngine(
  projectRoot: string,
