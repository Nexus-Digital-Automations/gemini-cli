...
export declare class CostCalculationEngine {
     ...
     */
    calculateUsage(currentUsage: number, limit: number, period: 'daily' | 'weekly' | 'monthly', periodElapsed: number): UsageCalculationResult;
    /**
 ...
 */
export declare function createCostCalculationEngine(customPricing?: ModelPricing[]): CostCalculationEngine;
