 ...
 * @version 1.0.0
 */
import type { AllocationCandidate, AllocationRecommendation, AllocationConstraints, FeatureCostAnalysis, AllocationLogger } from '../types.js';
/**
 ...
 */
export type RebalancingStrategy = 'reactive' | 'proactive' | 'adaptive' | 'threshold_based' | 'machine_learning' | 'hybrid';
/**
...
export declare class DynamicRebalancer {
     ...
     */
    constructor(config: Partial<DynamicRebalancingConfig> | undefined, logger: AllocationLogger);
    /**
     ...
     */
    analyzeRebalancingNeeds(candidates: AllocationCandidate[], historicalData: Record<string, FeatureCostAnalysis[]>): RebalancingAnalysis;
    /**
     * Execute rebalancing actions
     * @param analysis - Rebalancing analysis with recommended actions
     * @returns Execution result
     */
    executeRebalancing(analysis: RebalancingAnalysis): Promise<RebalancingExecutionResult>;
    /**
     ...
     */
    getRebalancingRecommendations(candidates: AllocationCandidate[], historicalData: Record<string, FeatureCostAnalysis[]>): AllocationRecommendation[];
    /**
 ...
 */
export declare function createDynamicRebalancer(config?: Partial<DynamicRebalancingConfig>, logger?: AllocationLogger): DynamicRebalancer;
