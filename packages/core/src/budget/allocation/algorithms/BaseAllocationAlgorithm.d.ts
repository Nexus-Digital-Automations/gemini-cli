...
import type { AllocationCandidate, AllocationRecommendation, AllocationAlgorithmConfig, AllocationOptimizationResult, AllocationStrategy } from '../types.js';
/**
...
export declare abstract class BaseAllocationAlgorithm {
     ...
     */
    constructor(strategy: AllocationStrategy, config: AllocationAlgorithmConfig, logger: AllocationLogger);
    /**
     ...
     */
    optimize(candidates: AllocationCandidate[]): Promise<AllocationOptimizationResult>;
    /**
     ...
     */
    protected abstract executeOptimization(candidates: AllocationCandidate[]): Promise<AllocationRecommendation[]>;
    /**
     ...
     */
    protected calculateOptimizationScore(originalCandidates: AllocationCandidate[], recommendations: AllocationRecommendation[]): number;
    /**
     ...
     * @throws Error if validation fails
     */
    protected validateResults(originalCandidates: AllocationCandidate[], recommendations: AllocationRecommendation[]): void;
    /**
     ...
     */
    protected calculateCostImprovement(originalCandidates: AllocationCandidate[], recommendations: AllocationRecommendation[]): number;
    /**
     ...
     */
    protected calculateROIImprovement(originalCandidates: AllocationCandidate[], recommendations: AllocationRecommendation[]): number;
    /**
     ...
     */
    protected calculateEfficiencyScore(originalCandidates: AllocationCandidate[], recommendations: AllocationRecommendation[]): number;
    /**
     ...
     */
    protected validateBudgetBalance(originalCandidates: AllocationCandidate[], recommendations: AllocationRecommendation[]): boolean;
    /**
     ...
     */
    protected validateImprovement(originalCandidates: AllocationCandidate[], recommendations: AllocationRecommendation[]): boolean;
    /**
     * Find candidate by resource ID
     * @param resourceId - Resource identifier
     * @returns Matching candidate or undefined
     */
    protected findCandidateById(_resourceId: string): AllocationCandidate | undefined;
    /**
