 ...
 */
export declare function createAllocationAlgorithm(
 ...
 */
export declare function getDefaultAlgorithmConfig(
  strategy: AllocationStrategy,
): AllocationAlgorithmConfig;
/**
 ...
 */
export declare function validateAlgorithmConfig(
  config: AllocationAlgorithmConfig,
): void;
/**
 ...
 */
export declare function getAlgorithmMetrics(
  algorithm: BaseAllocationAlgorithm,
): {
  strategy: AllocationStrategy;
 ...
 */
export declare function compareAlgorithmPerformance(
  results: Array<{
    strategy: AllocationStrategy;
