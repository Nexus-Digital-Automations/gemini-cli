...
import { type ReportConfig, type VisualizationArtifact } from './historical-visualization.js';
/**
...
export interface AnalysisSchedule {
    id: string;
    type: 'trend_analysis' | 'forecast_update' | 'anomaly_detection' | 'report_generation';
...
export declare class HistoricalBudgetService {
    ...
    private cache;
    constructor(projectRoot: string, budgetSettings: BudgetSettings, config?: Partial<HistoricalServiceConfig>);
    /**
     ...
     */
    generateReports(results: HistoricalAnalysisResults, customConfig?: Partial<ReportConfig>): Promise<VisualizationArtifact[]>;
    /**
 ...
 */
export declare function createHistoricalBudgetService(projectRoot: string, budgetSettings: BudgetSettings, config?: Partial<HistoricalServiceConfig>): HistoricalBudgetService;
