...
import type { AnalyticsEngine, FeatureCostAnalysis, OptimizationRecommendation } from '../index';
...
export declare class BudgetDashboard {
    ...
    private currentData?;
    constructor(budgetTracker: BudgetTracker, analytics: AnalyticsEngine, config?: DashboardConfig);
    /**
 ...
 */
export declare function createBudgetDashboard(budgetTracker: BudgetTracker, analytics: AnalyticsEngine, config?: DashboardConfig): BudgetDashboard;
/**
 * Export types for external use
 */
export type { DashboardConfig, DashboardSections, DashboardData, BudgetAlert, CurrentUsageData, CostProjections, TrendsData, };
