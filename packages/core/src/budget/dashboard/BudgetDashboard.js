...
export class BudgetDashboard {
     ...
     */
    async collectBudgetDashboardData() {
        ...
        const projections = this.generateBudgetCostProjections(currentUsage, settings.dailyLimit || 0);
     ...
     */
    generateBudgetCostProjections(usage, dailyLimit) {
     ...
     */
    generateBudgetDashboardAlerts(usage, _settings) {
        const alerts = [];
