...
export declare class BudgetConfigManager {
     ...
     */
    constructor(initialSettings?: Partial<BudgetSettings>, securityContext?: BudgetSecurityContext);
    /**
     ...
     */
    getConfigurationSummary(): Record<string, boolean | number | string | undefined>;
    /**
 ...
 */
export declare function createBudgetConfigManager(settings?: Partial<BudgetSettings>, securityContext?: BudgetSecurityContext): BudgetConfigManager;
