...
export declare class TestHarness {
     ...
     */
    executeTestSuite(algorithmSpec: AlgorithmTestSpec, config: TestSuiteConfig): Promise<TestExecutionResult>;
    /**
     ...
     */
    runBatchValidation(algorithmSpecs: AlgorithmTestSpec[], testSuiteConfig: TestSuiteConfig): Promise<Map<string, TestExecutionResult>>;
    /**
     ...
     */
    startContinuousTesting(algorithmSpecs: AlgorithmTestSpec[], config: TestSuiteConfig, intervalMs?: number): NodeJS.Timeout;
