...
import type { CostDataPoint, OptimizationRecommendation, CostProjection, BurnRateAnalysis, TrendAnalysis, VarianceDetection } from '../types.js';
/**
...
export declare class BudgetOptimizationEngine {
     ...
     */
    static generateOptimizationPlan(costData: CostDataPoint[], currentBudget: {
        total: number;
        used: number;
        remaining: number;
    }, projection: CostProjection, burnRate: BurnRateAnalysis, trend: TrendAnalysis, variance: VarianceDetection, targetSavings?: number): Promise<{
     ...
     */
    static analyzeCostEfficiency(costData: CostDataPoint[], burnRate: BurnRateAnalysis): {
        efficiency: Array<{
            category: string;
            efficiency: number;
            costPerUnit: number;
     ...
     */
    static createOptimizationScenarios(costData: CostDataPoint[], currentBudget: {
        total: number;
        used: number;
        remaining: number;
    }, projection: CostProjection): Array<{
        scenario: string;
        description: string;
