...
export declare class MathematicalAlgorithms {
     ...
     */
    static calculateMovingAverage(dataPoints: CostDataPoint[], config: MovingAverageAnalysis['config']): MovingAverageAnalysis;
    /**
     ...
     */
    static detectVariances(dataPoints: CostDataPoint[], algorithm?: VarianceDetection['algorithm']): VarianceDetection;
