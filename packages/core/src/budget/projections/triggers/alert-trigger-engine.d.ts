 ...
 */
import type { BudgetAlertConfig, BudgetAlert, CostDataPoint, CostProjection, VarianceDetection } from '../types.js';
/**
...
export declare class AlertTriggerEngine {
     ...
     */
    static evaluateAllTriggers(costData: CostDataPoint[], alertConfigs: BudgetAlertConfig[], currentBudget: {
        total: number;
        used: number;
        remaining: number;
    }, projection?: CostProjection, variance?: VarianceDetection): TriggerEvaluationResult[];
    /**
     * Evaluate a single trigger configuration
     */
    static evaluateTrigger(config: BudgetAlertConfig, costData: CostDataPoint[], currentBudget: {
        total: number;
        used: number;
        remaining: number;
    }, projection?: CostProjection, variance?: VarianceDetection): TriggerEvaluationResult;
     ...
     */
    static evaluateCompositeTriggers(basicResults: TriggerEvaluationResult[], costData: CostDataPoint[], currentBudget: {
        total: number;
        used: number;
        remaining: number;
    }, projection?: CostProjection, variance?: VarianceDetection): TriggerEvaluationResult[];
     ...
     */
    static createIntelligentTriggers(costData: CostDataPoint[], currentBudget: {
        total: number;
        used: number;
        remaining: number;
    }, variance?: VarianceDetection): BudgetAlertConfig[];
