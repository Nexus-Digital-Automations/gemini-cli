...
export interface EscalationRule {
  id: string;
  condition: {
    alertAge: number; // Minutes since alert creation
...
export class AlertTriggerEngine {
  ...
  private static escalationRules = new Map<string, EscalationRule>();
  private static alertHistory = new Map<string, BudgetAlert[]>();
