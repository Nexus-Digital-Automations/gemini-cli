...
import type { CostDataPoint, CostProjection, BurnRateAnalysis } from '../types.js';
/**
...
export declare class CostForecastingEngine {
     ...
     */
    static generateProjections(historicalData: CostDataPoint[], projectionDays?: number, confidenceLevel?: number): Promise<CostProjection>;
    /**
     * Generate burn rate analysis for budget runway calculations
     */
    static calculateBurnRateAnalysis(dataPoints: CostDataPoint[], currentBudget?: number): BurnRateAnalysis;
