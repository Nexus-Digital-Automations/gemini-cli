...
import type { TimeSeriesStorage, BudgetUsageTimeSeriesPoint, AggregatedUsageData, StorageConfig, StorageStats, QueryRange, StorageOperationResult } from './types.js';
/**
 ...
 */
export declare function createFileBasedTimeSeriesStorage(config?: Partial<StorageConfig>): FileBasedTimeSeriesStorage;
