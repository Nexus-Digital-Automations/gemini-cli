 ...
 */
export type ValidationRuleType = 'required' | 'type' | 'range' | 'format' | 'enum' | 'unique' | 'reference' | 'temporal' | 'business' | 'statistical' | 'custom';
/**
...
export interface ValidationRule {
    ...
    validator?: (context: ValidationContext) => ValidationIssue[] | Promise<ValidationIssue[]>;
...
export interface ValidationEngine {
     ...
     * Validate dataset
     */
    validate(data: BudgetUsageTimeSeriesPoint[], options?: {
        ruleFilter?: {
     ...
     */
    validateRecord(record: BudgetUsageTimeSeriesPoint, context: Partial<ValidationContext>): Promise<ValidationIssue[]>;
    /**
     * Assess data quality
     */
     ...
     */
    autoFix(data: BudgetUsageTimeSeriesPoint[], issues: ValidationIssue[], options?: {
     ...
     */
    exportReport(result: ValidationResult, format: 'json' | 'html' | 'csv' | 'pdf'): Promise<string>;
}
/**
...
export interface ValidationMonitor {
     ...
     */
    startMonitoring(dataStream: AsyncIterable<BudgetUsageTimeSeriesPoint>, options?: {
        batchSize?: number;
        interval?: number;
        rules?: string[];
 ...
 */
export type ValidationEventType = 'validation_started' | 'validation_completed' | 'validation_failed' | 'rule_added' | 'rule_removed' | 'rule_updated' | 'issue_found' | 'auto_fix_applied' | 'quality_threshold_breached';
/**
 ...
 */
export type CreateValidationEngine = (config?: Partial<ValidationConfig>) => ValidationEngine;
export type CreateValidationMonitor = (engine: ValidationEngine, config?: Partial<ValidationConfig>) => ValidationMonitor;
