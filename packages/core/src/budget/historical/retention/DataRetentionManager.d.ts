 ...
 */
export declare class DataRetentionManager implements RetentionManager, RetentionScheduler, LegalHoldManager, ComplianceReporter {
    private storage;
    ...
    placeLegalHold(holdId: string, criteria: RetentionCondition[], reason: string): Promise<void>;
    ...
    generateComplianceReport(startDate: number, endDate: number, format: 'json' | 'csv' | 'pdf'): Promise<any>;
 ...
 */
export declare function createDataRetentionManager(storage: TimeSeriesStorage, baseDir: string): DataRetentionManager;
