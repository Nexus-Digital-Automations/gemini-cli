 ...
 */
export type CompressionAlgorithm = 'gzip' | 'brotli' | 'lz4' | 'snappy' | 'delta' | 'rle' | 'huffman' | 'adaptive';
/**
...
export interface CompressionEngine {
     ...
     */
    compressBlock(block: DataBlock, options?: {
        algorithm?: CompressionAlgorithm;
        level?: CompressionLevel;
        strategy?: CompressionStrategy;
     ...
     */
    compressBlocks(blocks: DataBlock[], options?: {
        algorithm?: CompressionAlgorithm;
        level?: CompressionLevel;
        strategy?: CompressionStrategy;
     ...
     */
    benchmarkAlgorithms(sampleData: BudgetUsageTimeSeriesPoint[], algorithms?: CompressionAlgorithm[]): Promise<Map<CompressionAlgorithm, {
        compressionRatio: number;
        compressionTime: number;
        decompressionTime: number;
        memoryUsage: number;
     ...
     */
    optimizeSettings(sampleData: BudgetUsageTimeSeriesPoint[]): Promise<Partial<CompressionConfig>>;
    /**
...
export interface AdaptiveCompressionManager {
     ...
     */
    analyzeAndRecommend(data: BudgetUsageTimeSeriesPoint[]): Promise<OptimizationResult>;
    /**
     * Learn from compression results and improve recommendations
     */
    learnFromResults(data: BudgetUsageTimeSeriesPoint[], compressionResults: Map<CompressionAlgorithm, {
        ratio: number;
        time: number;
        success: boolean;
    }>): Promise<void>;
