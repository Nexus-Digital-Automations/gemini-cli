    ...
    projectState: z.ZodObject<
      {
        ...
        lintStatus: z.ZodEnum<
          ['clean', 'warnings', 'errors', 'in-progress', 'unknown']
        >;
      ...
      z.ZodTypeAny,
      {
        ...
        lintStatus: 'clean' | 'unknown' | 'errors' | 'in-progress' | 'warnings';
        gitStatus: 'clean' | 'unknown' | 'modified' | 'conflicted';
    ...
    userPreferences: z.ZodObject<
      {
        ...
        preferredWorkingHours: z.ZodOptional<
          z.ZodObject<
            {
              start: z.ZodNumber;
              end: z.ZodNumber;
    ...
    context: z.ZodObject<
      {
        ...
        projectState: z.ZodObject<
          {
            lastBuildTime: z.ZodOptional<z.ZodNumber>;
            buildStatus: z.ZodEnum<
              ['success', 'failed', 'in-progress', 'unknown']
            >;
            testStatus: z.ZodEnum<
              ['passing', 'failing', 'in-progress', 'unknown']
            >;
            lintStatus: z.ZodEnum<
              ['clean', 'warnings', 'errors', 'in-progress', 'unknown']
            >;
