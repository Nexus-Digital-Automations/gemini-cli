...
/**
 * System metrics collector for decision context.
 */
...
export class ContextCollector {
  ...
  private readonly COLLECTION_CACHE_MS = 1000; // Cache context for 1 second
   ...
   */
  async collect(): Promise<DecisionContext> {
   ...
   */
  private async collectSystemLoad(): Promise<DecisionContext['systemLoad']> {
    try {
   ...
   */
  private async readFeaturesJson(): Promise<any> {
    try {
   ...
   */
  private deriveAgentCapabilities(agentId: string): string[] {
