...
describe('AllocationStrategies', () => {
    ...
    test('should have appropriate preemption settings', () => {
        expect(AllocationStrategies.Efficiency.preemption.minPriorityDifference).toBeLessThan(AllocationStrategies.Fairness.preemption.minPriorityDifference);
        expect(AllocationStrategies.Fairness.preemption.enabled).toBe(false);
        expect(AllocationStrategies.DeadlineOptimized.preemption.gracePeriod).toBeLessThan(AllocationStrategies.Balanced.preemption.gracePeriod);
    });
    test('should have logical overcommit ratios', () => {
        expect(AllocationStrategies.Efficiency.overcommit.ratio).toBeGreaterThan(AllocationStrategies.Balanced.overcommit.ratio);
        expect(AllocationStrategies.Fairness.overcommit.enabled).toBe(false);
    });
});
//# sourceMappingURL=resourceAllocator.test.js.map