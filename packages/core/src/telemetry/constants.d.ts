...
export declare const METRIC_STARTUP_TIME = "gemini_cli.startup.duration";
export declare const METRIC_MEMORY_USAGE = "gemini_cli.memory.usage";
export declare const METRIC_CPU_USAGE = "gemini_cli.cpu.usage";
export declare const METRIC_TOOL_QUEUE_DEPTH = "gemini_cli.tool.queue.depth";
export declare const METRIC_TOOL_EXECUTION_BREAKDOWN = "gemini_cli.tool.execution.breakdown";
export declare const METRIC_TOKEN_EFFICIENCY = "gemini_cli.token.efficiency";
export declare const METRIC_API_REQUEST_BREAKDOWN = "gemini_cli.api.request.breakdown";
export declare const METRIC_PERFORMANCE_SCORE = "gemini_cli.performance.score";
export declare const METRIC_REGRESSION_DETECTION = "gemini_cli.performance.regression";
export declare const METRIC_REGRESSION_PERCENTAGE_CHANGE = "gemini_cli.performance.regression.percentage_change";
export declare const METRIC_BASELINE_COMPARISON = "gemini_cli.performance.baseline.comparison";
