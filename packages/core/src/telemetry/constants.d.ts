...
export declare const METRIC_API_REQUEST_LATENCY =
...
export declare const METRIC_FILE_OPERATION_COUNT =
  'gemini_cli.file.operation.count';
export declare const METRIC_INVALID_CHUNK_COUNT =
  'gemini_cli.chat.invalid_chunk.count';
export declare const METRIC_CONTENT_RETRY_COUNT =
  'gemini_cli.chat.content_retry.count';
export declare const METRIC_CONTENT_RETRY_FAILURE_COUNT =
  'gemini_cli.chat.content_retry_failure.count';
export declare const EVENT_MODEL_ROUTING = 'gemini_cli.model_routing';
export declare const EVENT_FLASH_ESCALATION = 'gemini_cli.flash_escalation';
export declare const METRIC_MODEL_ROUTING_LATENCY =
  'gemini_cli.model_routing.latency';
export declare const METRIC_MODEL_ROUTING_FAILURE_COUNT =
  'gemini_cli.model_routing.failure.count';
export declare const METRIC_FLASH_ESCALATION_COUNT =
  'gemini_cli.flash_escalation.count';
