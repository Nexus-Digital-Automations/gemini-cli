...
export declare class DashboardApiServer extends EventEmitter {
    ...
    private isRunning;
    constructor(config: DashboardConfig, tokenTracker: RealtimeTokenTracker, storageEngine: AnalyticsStorageEngine, intelligenceEngine: AnalyticsIntelligenceEngine);
    /**
 ...
 */
export declare function createDashboardServer(tokenTracker: RealtimeTokenTracker, storageEngine: AnalyticsStorageEngine, intelligenceEngine: AnalyticsIntelligenceEngine, config?: Partial<DashboardConfig>): DashboardApiServer;
