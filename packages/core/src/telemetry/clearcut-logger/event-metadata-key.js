...
(function (EventMetadataKey) {
  ...
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_TOOL_ERROR_MESSAGE'] = 18)] =
    'GEMINI_CLI_TOOL_ERROR_MESSAGE';
  ...
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_KITTY_TRUNCATED_SEQUENCE'] = 52)
  ] = 'GEMINI_CLI_KITTY_TRUNCATED_SEQUENCE';
