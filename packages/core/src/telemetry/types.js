...
export class FlashEscalationEvent {
    'event.name';
    'event.timestamp';
    request_hash;
    failure_count;
    ...
    constructor(request_hash, failure_count, escalation_reason, threshold_reached, session_memory_enabled, time_since_last_failure_ms) {
