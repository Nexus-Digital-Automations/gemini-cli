 ...
 */
export declare function auditSecurityEvent(eventType: string, severity: EventSeverity, details: Record<string, unknown>): (req: AuditRequest, res: Response, next: NextFunction) => void;
/**
...
declare function filterSensitiveHeaders(headers: Record<string, unknown>): Record<string, unknown>;
declare function filterSensitiveData(data: unknown): unknown;
/**
