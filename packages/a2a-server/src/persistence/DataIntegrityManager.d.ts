...
export declare class DataIntegrityManager {
     ...
     */
    verifyFileIntegrity(filePath: string, expectedChecksum?: string): Promise<IntegrityCheckResult>;
    /**
     * Create backup of a file or directory
     */
    createBackup(originalPath: string, options?: {
        type?: 'auto' | 'manual' | 'recovery';
        compress?: boolean;
     ...
     */
    restoreFromBackup(backupId: string, targetPath?: string, options?: {
