...
export declare class SessionManager {
     ...
     */
    createTaskCorrelation(taskId: string, parentTaskId?: string, relatedTaskIds?: string[]): Promise<TaskCorrelation>;
    /**
     * Update task correlation with new session information
     */
    updateTaskCorrelation(taskId: string, updates: Partial<TaskCorrelation>): Promise<TaskCorrelation>;
    /**
     * Transfer task ownership to another session
     */
    transferTaskOwnership(taskId: string, targetSessionId: string, reason?: string): Promise<SessionHandoff>;
    /**
     ...
     */
    completeTask(taskId: string, completionSummary: string, preservedState?: Record<string, unknown>): Promise<TaskCorrelation>;
    /**
