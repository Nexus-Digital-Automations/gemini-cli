    ...
    generateReport() {
        ...
        this.metrics.forEach((metrics, suite) => {
            ...
            suiteReports[suite] = {
                ...
                maxMemoryMB: memoryUsage.length > 0 ? Math.max(...memoryUsage.filter(Boolean)) : 0
            };
        });
        return {
...
//# sourceMappingURL=test-runner-config.js.map